...
public:
  ...
  ReactionDiffusionLinearForm(dolfin::FunctionSpace& V0, dolfin::Function& v0) : dolfin::Form()
  {
    std::tr1::shared_ptr<dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<dolfin::FunctionSpace>());
    function_spaces.push_back(_V0);
  ...
  ReactionDiffusionLinearForm(std::tr1::shared_ptr<dolfin::FunctionSpace> V0, std::tr1::shared_ptr<dolfin::Function> v0) : dolfin::Form()
  {
    function_spaces.push_back(V0);
