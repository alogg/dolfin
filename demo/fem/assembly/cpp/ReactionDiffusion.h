...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Number of operations to compute element tensor = 143
    // Compute geometry tensors
    // Number of operations to compute decalrations = 55
    ...
    // Number of operations to compute tensor = 88
...
public:
  ...
  virtual const char* signature() const
  {
    return "(dXa0[0, 1, 2]/dxb0[0, 1, 2])(dXa1[0, 1, 2]/dxb0[0, 1, 2]) | ((d/dXa0[0, 1, 2])vi0[0, 1, 2, 3])*((d/dXa1[0, 1, 2])vi1[0, 1, 2, 3])*dX(0) +  | vi0[0, 1, 2, 3]*vi1[0, 1, 2, 3]*dX(0)";
  }
