...
class UFC_PoissonBilinearForm_cell_integral_0_quadrature: public ufc::cell_integral
{
public:

  /// Constructor
  UFC_PoissonBilinearForm_cell_integral_0_quadrature() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_PoissonBilinearForm_cell_integral_0_quadrature()
  {
    // Do nothing
  }
...
private:
  ...
  UFC_PoissonBilinearForm_cell_integral_0_quadrature integral_0_quadrature;
...
class UFC_PoissonBilinearForm_exterior_facet_integral_0_quadrature: public ufc::exterior_facet_integral
{
public:

  /// Constructor
  UFC_PoissonBilinearForm_exterior_facet_integral_0_quadrature() : ufc::exterior_facet_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_PoissonBilinearForm_exterior_facet_integral_0_quadrature()
  {
    // Do nothing
  }
    ...
    case 0:
      ...
      for (unsigned int ip = 0; ip < 2; ip++)
      {
        ...
        for (unsigned int j = 0; j < 2; j++)
        {
          ...
          {
            // Number of operations to compute entry = 3
            A[nzc5[j]*3 + nzc0[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip0;
            // Number of operations to compute entry = 3
            A[nzc0[j]*3 + nzc0[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip1;
            // Number of operations to compute entry = 3
            A[nzc0[j]*3 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip2;
            // Number of operations to compute entry = 3
            A[nzc0[j]*3 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip0;
            // Number of operations to compute entry = 3
            A[nzc6[j]*3 + nzc0[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip2;
          }// end loop over 'k'
        }// end loop over 'j'
      }// end loop over 'ip'
      }
    ...
    case 1:
      ...
      for (unsigned int ip = 0; ip < 2; ip++)
      {
        ...
        for (unsigned int j = 0; j < 2; j++)
        {
          ...
          {
            // Number of operations to compute entry = 3
            A[nzc6[j]*3 + nzc1[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip0;
            // Number of operations to compute entry = 3
            A[nzc1[j]*3 + nzc1[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip1;
            // Number of operations to compute entry = 3
            A[nzc1[j]*3 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip2;
            // Number of operations to compute entry = 3
            A[nzc1[j]*3 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip0;
            // Number of operations to compute entry = 3
            A[nzc5[j]*3 + nzc1[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip2;
          }// end loop over 'k'
        }// end loop over 'j'
      }// end loop over 'ip'
      }
    ...
    case 2:
      ...
      for (unsigned int ip = 0; ip < 2; ip++)
      {
        ...
        for (unsigned int j = 0; j < 2; j++)
        {
          ...
          {
            // Number of operations to compute entry = 3
            A[nzc2[j]*3 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip0;
            // Number of operations to compute entry = 3
            A[nzc2[j]*3 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip1;
            // Number of operations to compute entry = 3
            A[nzc2[j]*3 + nzc2[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip2;
            // Number of operations to compute entry = 3
            A[nzc5[j]*3 + nzc2[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip0;
            // Number of operations to compute entry = 3
            A[nzc6[j]*3 + nzc2[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip1;
          }// end loop over 'k'
        }// end loop over 'j'
      }// end loop over 'ip'
      }
...
private:
  ...
  UFC_PoissonBilinearForm_exterior_facet_integral_0_quadrature integral_0_quadrature;
...
class UFC_PoissonBilinearForm_interior_facet_integral_0_quadrature: public ufc::interior_facet_integral
{
public:

  /// Constructor
  UFC_PoissonBilinearForm_interior_facet_integral_0_quadrature() : ufc::interior_facet_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_PoissonBilinearForm_interior_facet_integral_0_quadrature()
  {
    // Do nothing
  }
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 2; j++)
          {
            for (unsigned int k = 0; k < 2; k++)
            {
              ...
              // Number of operations to compute entry = 3
              A[(nzc0[j] + 3)*6 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip4;
              // Number of operations to compute entry = 3
              ...
              // Number of operations to compute entry = 3
              A[(nzc0[j] + 3)*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip9;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + (nzc0[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip9;
              // Number of operations to compute entry = 3
              A[nzc0[j]*6 + (nzc0[k] + 3)] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip8;
              // Number of operations to compute entry = 3
              A[nzc0[j]*6 + nzc0[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip10;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + nzc0[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip7;
              // Number of operations to compute entry = 3
              A[nzc0[j]*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip1;
              // Number of operations to compute entry = 3
      ...
      case 1:
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 2; j++)
          {
            ...
            {
              // Number of operations to compute entry = 3
              A[(nzc5[j] + 3)*6 + (nzc1[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip0;
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + nzc0[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip1;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + nzc0[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip2;
              // Number of operations to compute entry = 3
              A[(nzc5[j] + 3)*6 + nzc0[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip3;
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip4;
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + (nzc5[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip0;
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip5;
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + (nzc1[k] + 3)] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip6;
              // Number of operations to compute entry = 3
              A[(nzc6[j] + 3)*6 + (nzc1[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip4;
              // Number of operations to compute entry = 3
              A[nzc5[j]*6 + nzc0[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip7;
              // Number of operations to compute entry = 3
              A[nzc0[j]*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip2;
              // Number of operations to compute entry = 3
              A[(nzc6[j] + 3)*6 + nzc0[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip8;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + (nzc1[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip9;
              // Number of operations to compute entry = 3
              A[nzc0[j]*6 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip7;
              // Number of operations to compute entry = 3
              A[nzc0[j]*6 + nzc0[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip10;
              // Number of operations to compute entry = 3
              A[nzc0[j]*6 + (nzc1[k] + 3)] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip1;
              // Number of operations to compute entry = 3
              ...
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip9;
            }// end loop over 'k'
          }// end loop over 'j'
        }// end loop over 'ip'
        }
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 2; j++)
          {
            for (unsigned int k = 0; k < 2; k++)
            {
              ...
              // Number of operations to compute entry = 3
              A[(nzc2[j] + 3)*6 + nzc0[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip3;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + (nzc2[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip1;
              // Number of operations to compute entry = 3
              A[nzc0[j]*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip7;
              // Number of operations to compute entry = 3
              A[(nzc6[j] + 3)*6 + nzc0[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip7;
              // Number of operations to compute entry = 3
              A[nzc0[j]*6 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip8;
              // Number of operations to compute entry = 3
              ...
              // Number of operations to compute entry = 3
              A[nzc5[j]*6 + nzc0[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip8;
              // Number of operations to compute entry = 3
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 2; j++)
          {
            for (unsigned int k = 0; k < 2; k++)
            {
              ...
              // Number of operations to compute entry = 3
              A[(nzc0[j] + 3)*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip6;
              // Number of operations to compute entry = 3
              ...
              // Number of operations to compute entry = 3
              A[(nzc6[j] + 3)*6 + (nzc0[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip6;
              // Number of operations to compute entry = 3
              A[nzc1[j]*6 + (nzc0[k] + 3)] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip0;
              // Number of operations to compute entry = 3
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 2; j++)
          {
            for (unsigned int k = 0; k < 2; k++)
            {
              ...
              // Number of operations to compute entry = 3
              A[nzc1[j]*6 + (nzc5[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip8;
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + nzc1[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip7;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + (nzc1[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip9;
              // Number of operations to compute entry = 3
              A[nzc1[j]*6 + nzc1[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip10;
              // Number of operations to compute entry = 3
              A[(nzc5[j] + 3)*6 + nzc1[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip8;
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip9;
            }// end loop over 'k'
          }// end loop over 'j'
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 2; j++)
          {
            for (unsigned int k = 0; k < 2; k++)
            {
              ...
              A[nzc1[j]*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip1;
              // Number of operations to compute entry = 3
              A[nzc1[j]*6 + (nzc2[k] + 3)] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip7;
              // Number of operations to compute entry = 3
              A[nzc1[j]*6 + nzc1[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip8;
              // Number of operations to compute entry = 3
              A[nzc1[j]*6 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip2;
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 2; j++)
          {
            for (unsigned int k = 0; k < 2; k++)
            {
              ...
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip2;
              // Number of operations to compute entry = 3
              A[(nzc5[j] + 3)*6 + (nzc0[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip3;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + (nzc5[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip1;
              // Number of operations to compute entry = 3
              A[(nzc6[j] + 3)*6 + (nzc0[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip4;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip5;
              // Number of operations to compute entry = 3
              A[(nzc0[j] + 3)*6 + (nzc5[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip3;
              // Number of operations to compute entry = 3
              A[(nzc0[j] + 3)*6 + (nzc0[k] + 3)] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip6;
              // Number of operations to compute entry = 3
              A[(nzc6[j] + 3)*6 + nzc2[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip2;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + nzc2[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip7;
              // Number of operations to compute entry = 3
              A[(nzc0[j] + 3)*6 + nzc2[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip0;
              // Number of operations to compute entry = 3
              A[nzc5[j]*6 + nzc2[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip5;
              // Number of operations to compute entry = 3
              A[(nzc0[j] + 3)*6 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip8;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + (nzc0[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip9;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip7;
              // Number of operations to compute entry = 3
              A[(nzc0[j] + 3)*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip4;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + nzc2[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip10;
              // Number of operations to compute entry = 3
              A[(nzc0[j] + 3)*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip9;
              // Number of operations to compute entry = 3
              A[nzc5[j]*6 + (nzc0[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip8;
            }// end loop over 'k'
          }// end loop over 'j'
        }// end loop over 'ip'
        }
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 2; j++)
          {
            for (unsigned int k = 0; k < 2; k++)
            {
              ...
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + nzc2[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip2;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + (nzc5[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip1;
              // Number of operations to compute entry = 3
              A[(nzc1[j] + 3)*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip3;
              ...
              A[(nzc1[j] + 3)*6 + (nzc1[k] + 3)] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip6;
              // Number of operations to compute entry = 3
              A[(nzc6[j] + 3)*6 + nzc2[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip7;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + nzc2[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip8;
              // Number of operations to compute entry = 3
              A[nzc5[j]*6 + (nzc1[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip5;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip7;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip8;
              // Number of operations to compute entry = 3
              A[(nzc6[j] + 3)*6 + (nzc1[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip3;
              // Number of operations to compute entry = 3
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 2; j++)
          {
            for (unsigned int k = 0; k < 2; k++)
            {
              ...
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + nzc2[k]] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip3;
              // Number of operations to compute entry = 3
              A[(nzc2[j] + 3)*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip4;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + (nzc5[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip2;
              // Number of operations to compute entry = 3
              A[(nzc5[j] + 3)*6 + (nzc2[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip5;
              // Number of operations to compute entry = 3
              A[(nzc6[j] + 3)*6 + (nzc2[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip6;
              // Number of operations to compute entry = 3
              ...
              A[(nzc2[j] + 3)*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip6;
              // Number of operations to compute entry = 3
              A[(nzc2[j] + 3)*6 + nzc2[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip0;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + nzc6[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip3;
              // Number of operations to compute entry = 3
              A[(nzc2[j] + 3)*6 + (nzc5[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip5;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + (nzc6[k] + 3)] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip7;
              // Number of operations to compute entry = 3
              A[nzc5[j]*6 + (nzc2[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip9;
              // Number of operations to compute entry = 3
              A[nzc6[j]*6 + (nzc2[k] + 3)] += FE0_f0[ip][k]*FE0_f2_D01[ip][j]*Gip4;
              // Number of operations to compute entry = 3
              A[nzc2[j]*6 + nzc2[k]] += FE0_f0[ip][j]*FE0_f0[ip][k]*Gip10;
              // Number of operations to compute entry = 3
              A[(nzc2[j] + 3)*6 + nzc5[k]] += FE0_f0[ip][j]*FE0_f2_D01[ip][k]*Gip9;
            }// end loop over 'k'
          }// end loop over 'j'
        }// end loop over 'ip'
        }
...
private:
  ...
  UFC_PoissonBilinearForm_interior_facet_integral_0_quadrature integral_0_quadrature;
...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(IndexSum(Product(Indexed(ComponentTensor(SpatialDerivative(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0), MultiIndex((Index(0),), {Index(0): 2})), MultiIndex((Index(0),), {Index(0): 2})), MultiIndex((Index(1),), {Index(1): 2})), Indexed(ComponentTensor(SpatialDerivative(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1), MultiIndex((Index(2),), {Index(2): 2})), MultiIndex((Index(2),), {Index(2): 2})), MultiIndex((Index(1),), {Index(1): 2}))), MultiIndex((Index(1),), {Index(1): 2})), Measure('cell', 0, None)), Integral(Sum(Product(Division(FloatValue(4.0, (), (), {}), PositiveRestricted(Constant(Cell('triangle', 1), 1))), IndexSum(Product(Indexed(Sum(ComponentTensor(Product(Indexed(NegativeRestricted(VectorConstant(Cell('triangle', 1), 2, 0)), MultiIndex((Index(3),), {Index(3): 2})), NegativeRestricted(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0))), MultiIndex((Index(3),), {Index(3): 2})), ComponentTensor(Product(Indexed(PositiveRestricted(VectorConstant(Cell('triangle', 1), 2, 0)), MultiIndex((Index(4),), {Index(4): 2})), PositiveRestricted(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0))), MultiIndex((Index(4),), {Index(4): 2}))), MultiIndex((Index(5),), {Index(5): 2})), Indexed(Sum(ComponentTensor(Product(Indexed(NegativeRestricted(VectorConstant(Cell('triangle', 1), 2, 0)), MultiIndex((Index(6),), {Index(6): 2})), NegativeRestricted(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1))), MultiIndex((Index(6),), {Index(6): 2})), ComponentTensor(Product(Indexed(PositiveRestricted(VectorConstant(Cell('triangle', 1), 2, 0)), MultiIndex((Index(7),), {Index(7): 2})), PositiveRestricted(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1))), MultiIndex((Index(7),), {Index(7): 2}))), MultiIndex((Index(5),), {Index(5): 2}))), MultiIndex((Index(5),), {Index(5): 2}))), Sum(Product(IntValue(-1, (), (), {}), IndexSum(Product(Indexed(ComponentTensor(Product(FloatValue(0.5, (), (), {}), Indexed(Sum(NegativeRestricted(ComponentTensor(SpatialDerivative(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0), MultiIndex((Index(8),), {Index(8): 2})), MultiIndex((Index(8),), {Index(8): 2}))), PositiveRestricted(ComponentTensor(SpatialDerivative(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0), MultiIndex((Index(9),), {Index(9): 2})), MultiIndex((Index(9),), {Index(9): 2})))), MultiIndex((Index(10),), {Index(10): 2}))), MultiIndex((Index(10),), {Index(10): 2})), MultiIndex((Index(11),), {Index(11): 2})), Indexed(Sum(ComponentTensor(Product(Indexed(NegativeRestricted(VectorConstant(Cell('triangle', 1), 2, 0)), MultiIndex((Index(12),), {Index(12): 2})), NegativeRestricted(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1))), MultiIndex((Index(12),), {Index(12): 2})), ComponentTensor(Product(Indexed(PositiveRestricted(VectorConstant(Cell('triangle', 1), 2, 0)), MultiIndex((Index(13),), {Index(13): 2})), PositiveRestricted(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1))), MultiIndex((Index(13),), {Index(13): 2}))), MultiIndex((Index(11),), {Index(11): 2}))), MultiIndex((Index(11),), {Index(11): 2}))), Product(IntValue(-1, (), (), {}), IndexSum(Product(Indexed(ComponentTensor(Product(FloatValue(0.5, (), (), {}), Indexed(Sum(NegativeRestricted(ComponentTensor(SpatialDerivative(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1), MultiIndex((Index(14),), {Index(14): 2})), MultiIndex((Index(14),), {Index(14): 2}))), PositiveRestricted(ComponentTensor(SpatialDerivative(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1), MultiIndex((Index(15),), {Index(15): 2})), MultiIndex((Index(15),), {Index(15): 2})))), MultiIndex((Index(16),), {Index(16): 2}))), MultiIndex((Index(16),), {Index(16): 2})), MultiIndex((Index(17),), {Index(17): 2})), Indexed(Sum(ComponentTensor(Product(Indexed(NegativeRestricted(VectorConstant(Cell('triangle', 1), 2, 0)), MultiIndex((Index(18),), {Index(18): 2})), NegativeRestricted(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0))), MultiIndex((Index(18),), {Index(18): 2})), ComponentTensor(Product(Indexed(PositiveRestricted(VectorConstant(Cell('triangle', 1), 2, 0)), MultiIndex((Index(19),), {Index(19): 2})), PositiveRestricted(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0))), MultiIndex((Index(19),), {Index(19): 2}))), MultiIndex((Index(17),), {Index(17): 2}))), MultiIndex((Index(17),), {Index(17): 2}))))), Measure('interior_facet', 0, None)), Integral(Sum(Product(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1), Product(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0), Division(FloatValue(8.0, (), (), {}), Constant(Cell('triangle', 1), 1)))), Sum(Product(IntValue(-1, (), (), {}), IndexSum(Product(Indexed(ComponentTensor(Product(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0), Indexed(VectorConstant(Cell('triangle', 1), 2, 0), MultiIndex((Index(20),), {Index(20): 2}))), MultiIndex((Index(20),), {Index(20): 2})), MultiIndex((Index(21),), {Index(21): 2})), Indexed(ComponentTensor(SpatialDerivative(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1), MultiIndex((Index(22),), {Index(22): 2})), MultiIndex((Index(22),), {Index(22): 2})), MultiIndex((Index(21),), {Index(21): 2}))), MultiIndex((Index(21),), {Index(21): 2}))), Product(IntValue(-1, (), (), {}), IndexSum(Product(Indexed(ComponentTensor(Product(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 1), Indexed(VectorConstant(Cell('triangle', 1), 2, 0), MultiIndex((Index(23),), {Index(23): 2}))), MultiIndex((Index(23),), {Index(23): 2})), MultiIndex((Index(24),), {Index(24): 2})), Indexed(ComponentTensor(SpatialDerivative(BasisFunction(FiniteElement('Discontinuous Lagrange', Cell('triangle', 1), 1), 0), MultiIndex((Index(25),), {Index(25): 2})), MultiIndex((Index(25),), {Index(25): 2})), MultiIndex((Index(24),), {Index(24): 2}))), MultiIndex((Index(24),), {Index(24): 2}))))), Measure('exterior_facet', 0, None))])";
  }
...
class UFC_PoissonLinearForm_cell_integral_0_quadrature: public ufc::cell_integral
{
public:

  /// Constructor
  UFC_PoissonLinearForm_cell_integral_0_quadrature() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_PoissonLinearForm_cell_integral_0_quadrature()
  {
    // Do nothing
  }
...
private:
  ...
  UFC_PoissonLinearForm_cell_integral_0_quadrature integral_0_quadrature;
