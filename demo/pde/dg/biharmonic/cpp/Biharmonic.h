...
public:
                                    ...
                                    const ufc::cell& c) const
  {
    ...
    coordinates[3][0] = 0.000000000000000*x[0][0] + 0.500000000000000*x[1][0] + 0.500000000000000*x[2][0];
    coordinates[3][1] = 0.000000000000000*x[0][1] + 0.500000000000000*x[1][1] + 0.500000000000000*x[2][1];
    coordinates[4][0] = 0.500000000000000*x[0][0] + 0.000000000000000*x[1][0] + 0.500000000000000*x[2][0];
    coordinates[4][1] = 0.500000000000000*x[0][1] + 0.000000000000000*x[1][1] + 0.500000000000000*x[2][1];
    coordinates[5][0] = 0.500000000000000*x[0][0] + 0.500000000000000*x[1][0] + 0.000000000000000*x[2][0];
    coordinates[5][1] = 0.500000000000000*x[0][1] + 0.500000000000000*x[1][1] + 0.000000000000000*x[2][1];
  }
...
public:
                               ...
                               unsigned int facet1) const
  {
    ...
    {{3.999999999999997, 0.000000000000000, 4.000000000000000, 0.000000000000000, -8.000000000000000, 0.000000000000000},
    {4.000000000000001, 0.000000000000000, 4.000000000000000, 0.000000000000000, -8.000000000000004, 0.000000000000000}};
    ...
    {{3.999999999999997, 0.000000000000000, 0.000000000000000, 4.000000000000004, -4.000000000000005, -3.999999999999998},
    {4.000000000000000, 0.000000000000000, 0.000000000000000, 4.000000000000002, -4.000000000000004, -4.000000000000002}};
    
    static const double FE0_f2_D20[2][6] = \
    {{3.999999999999996, 3.999999999999997, 0.000000000000000, 0.000000000000000, 0.000000000000000, -7.999999999999993},
    {3.999999999999999, 3.999999999999998, 0.000000000000000, 0.000000000000000, 0.000000000000000, -7.999999999999996}};
      ...
      case 2:
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 6; j++)
          {
            ...
            {
              // Number of operations to compute entry: 96
              A[((j + 6))*12 + k] += ((((((((K1_01*K1_01*FE0_f2_D20[ip][j] + K1_01*K1_11*FE0_f2_D11[ip][j] + K1_11*K1_01*FE0_f2_D11[ip][j] + K1_11*K1_11*FE0_f2_D02[ip][j]) + (K1_00*K1_00*FE0_f2_D20[ip][j] + K1_00*K1_10*FE0_f2_D11[ip][j] + K1_10*K1_00*FE0_f2_D11[ip][j] + K1_10*K1_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K0_01*FE0_f0_D10[ip][k] + K0_11*FE0_f0_D01[ip][k]))*n01 + ((K0_00*FE0_f0_D10[ip][k] + K0_10*FE0_f0_D01[ip][k]))*n00)))*(-1.000000000000000) + (((((K0_01*K0_01*FE0_f0_D20[ip][k] + K0_01*K0_11*FE0_f0_D11[ip][k] + K0_11*K0_01*FE0_f0_D11[ip][k] + K0_11*K0_11*FE0_f0_D02[ip][k]) + (K0_00*K0_00*FE0_f0_D20[ip][k] + K0_00*K0_10*FE0_f0_D11[ip][k] + K0_10*K0_00*FE0_f0_D11[ip][k] + K0_10*K0_10*FE0_f0_D02[ip][k])))*0.500000000000000)*((((K1_00*FE0_f2_D10[ip][j] + K1_10*FE0_f2_D01[ip][j]))*n10 + ((K1_01*FE0_f2_D10[ip][j] + K1_11*FE0_f2_D01[ip][j]))*n11)))*(-1.000000000000000)) + (((((K1_00*FE0_f2_D10[ip][j] + K1_10*FE0_f2_D01[ip][j]))*n10 + ((K1_01*FE0_f2_D10[ip][j] + K1_11*FE0_f2_D01[ip][j]))*n11))*((((K0_01*FE0_f0_D10[ip][k] + K0_11*FE0_f0_D01[ip][k]))*n01 + ((K0_00*FE0_f0_D10[ip][k] + K0_10*FE0_f0_D01[ip][k]))*n00)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[((j + 6))*12 + (k + 6)] += ((((((((K1_01*K1_01*FE0_f2_D20[ip][j] + K1_01*K1_11*FE0_f2_D11[ip][j] + K1_11*K1_01*FE0_f2_D11[ip][j] + K1_11*K1_11*FE0_f2_D02[ip][j]) + (K1_00*K1_00*FE0_f2_D20[ip][j] + K1_00*K1_10*FE0_f2_D11[ip][j] + K1_10*K1_00*FE0_f2_D11[ip][j] + K1_10*K1_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K1_01*FE0_f2_D10[ip][k] + K1_11*FE0_f2_D01[ip][k]))*n11 + ((K1_00*FE0_f2_D10[ip][k] + K1_10*FE0_f2_D01[ip][k]))*n10)))*(-1.000000000000000) + (((((K1_00*K1_00*FE0_f2_D20[ip][k] + K1_00*K1_10*FE0_f2_D11[ip][k] + K1_10*K1_00*FE0_f2_D11[ip][k] + K1_10*K1_10*FE0_f2_D02[ip][k]) + (K1_01*K1_01*FE0_f2_D20[ip][k] + K1_01*K1_11*FE0_f2_D11[ip][k] + K1_11*K1_01*FE0_f2_D11[ip][k] + K1_11*K1_11*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K1_00*FE0_f2_D10[ip][j] + K1_10*FE0_f2_D01[ip][j]))*n10 + ((K1_01*FE0_f2_D10[ip][j] + K1_11*FE0_f2_D01[ip][j]))*n11)))*(-1.000000000000000)) + (((((K1_00*FE0_f2_D10[ip][j] + K1_10*FE0_f2_D01[ip][j]))*n10 + ((K1_01*FE0_f2_D10[ip][j] + K1_11*FE0_f2_D01[ip][j]))*n11))*((((K1_01*FE0_f2_D10[ip][k] + K1_11*FE0_f2_D01[ip][k]))*n11 + ((K1_00*FE0_f2_D10[ip][k] + K1_10*FE0_f2_D01[ip][k]))*n10)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[j*12 + (k + 6)] += ((((((((K1_00*K1_00*FE0_f2_D20[ip][k] + K1_00*K1_10*FE0_f2_D11[ip][k] + K1_10*K1_00*FE0_f2_D11[ip][k] + K1_10*K1_10*FE0_f2_D02[ip][k]) + (K1_01*K1_01*FE0_f2_D20[ip][k] + K1_01*K1_11*FE0_f2_D11[ip][k] + K1_11*K1_01*FE0_f2_D11[ip][k] + K1_11*K1_11*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K0_01*FE0_f0_D10[ip][j] + K0_11*FE0_f0_D01[ip][j]))*n01 + ((K0_00*FE0_f0_D10[ip][j] + K0_10*FE0_f0_D01[ip][j]))*n00)))*(-1.000000000000000) + (((((K0_01*K0_01*FE0_f0_D20[ip][j] + K0_01*K0_11*FE0_f0_D11[ip][j] + K0_11*K0_01*FE0_f0_D11[ip][j] + K0_11*K0_11*FE0_f0_D02[ip][j]) + (K0_00*K0_00*FE0_f0_D20[ip][j] + K0_00*K0_10*FE0_f0_D11[ip][j] + K0_10*K0_00*FE0_f0_D11[ip][j] + K0_10*K0_10*FE0_f0_D02[ip][j])))*0.500000000000000)*((((K1_01*FE0_f2_D10[ip][k] + K1_11*FE0_f2_D01[ip][k]))*n11 + ((K1_00*FE0_f2_D10[ip][k] + K1_10*FE0_f2_D01[ip][k]))*n10)))*(-1.000000000000000)) + (((((K0_01*FE0_f0_D10[ip][j] + K0_11*FE0_f0_D01[ip][j]))*n01 + ((K0_00*FE0_f0_D10[ip][j] + K0_10*FE0_f0_D01[ip][j]))*n00))*((((K1_01*FE0_f2_D10[ip][k] + K1_11*FE0_f2_D01[ip][k]))*n11 + ((K1_00*FE0_f2_D10[ip][k] + K1_10*FE0_f2_D01[ip][k]))*n10)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[j*12 + k] += ((((((((K0_01*K0_01*FE0_f0_D20[ip][k] + K0_01*K0_11*FE0_f0_D11[ip][k] + K0_11*K0_01*FE0_f0_D11[ip][k] + K0_11*K0_11*FE0_f0_D02[ip][k]) + (K0_00*K0_00*FE0_f0_D20[ip][k] + K0_00*K0_10*FE0_f0_D11[ip][k] + K0_10*K0_00*FE0_f0_D11[ip][k] + K0_10*K0_10*FE0_f0_D02[ip][k])))*0.500000000000000)*((((K0_01*FE0_f0_D10[ip][j] + K0_11*FE0_f0_D01[ip][j]))*n01 + ((K0_00*FE0_f0_D10[ip][j] + K0_10*FE0_f0_D01[ip][j]))*n00)))*(-1.000000000000000) + (((((K0_01*K0_01*FE0_f0_D20[ip][j] + K0_01*K0_11*FE0_f0_D11[ip][j] + K0_11*K0_01*FE0_f0_D11[ip][j] + K0_11*K0_11*FE0_f0_D02[ip][j]) + (K0_00*K0_00*FE0_f0_D20[ip][j] + K0_00*K0_10*FE0_f0_D11[ip][j] + K0_10*K0_00*FE0_f0_D11[ip][j] + K0_10*K0_10*FE0_f0_D02[ip][j])))*0.500000000000000)*((((K0_01*FE0_f0_D10[ip][k] + K0_11*FE0_f0_D01[ip][k]))*n01 + ((K0_00*FE0_f0_D10[ip][k] + K0_10*FE0_f0_D01[ip][k]))*n00)))*(-1.000000000000000)) + (((((K0_01*FE0_f0_D10[ip][j] + K0_11*FE0_f0_D01[ip][j]))*n01 + ((K0_00*FE0_f0_D10[ip][j] + K0_10*FE0_f0_D01[ip][j]))*n00))*((((K0_01*FE0_f0_D10[ip][k] + K0_11*FE0_f0_D01[ip][k]))*n01 + ((K0_00*FE0_f0_D10[ip][k] + K0_10*FE0_f0_D01[ip][k]))*n00)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
            }// end loop over 'k'
          }// end loop over 'j'
      ...
      case 0:
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 6; j++)
          {
            ...
            {
              // Number of operations to compute entry: 96
              A[((j + 6))*12 + k] += ((((((((K1_01*K1_01*FE0_f0_D20[ip][j] + K1_01*K1_11*FE0_f0_D11[ip][j] + K1_11*K1_01*FE0_f0_D11[ip][j] + K1_11*K1_11*FE0_f0_D02[ip][j]) + (K1_00*K1_00*FE0_f0_D20[ip][j] + K1_00*K1_10*FE0_f0_D11[ip][j] + K1_10*K1_00*FE0_f0_D11[ip][j] + K1_10*K1_10*FE0_f0_D02[ip][j])))*0.500000000000000)*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(-1.000000000000000) + (((((K0_01*K0_01*FE0_f2_D20[ip][k] + K0_01*K0_11*FE0_f2_D11[ip][k] + K0_11*K0_01*FE0_f2_D11[ip][k] + K0_11*K0_11*FE0_f2_D02[ip][k]) + (K0_00*K0_00*FE0_f2_D20[ip][k] + K0_00*K0_10*FE0_f2_D11[ip][k] + K0_10*K0_00*FE0_f2_D11[ip][k] + K0_10*K0_10*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K1_00*FE0_f0_D10[ip][j] + K1_10*FE0_f0_D01[ip][j]))*n10 + ((K1_01*FE0_f0_D10[ip][j] + K1_11*FE0_f0_D01[ip][j]))*n11)))*(-1.000000000000000)) + (((((K1_00*FE0_f0_D10[ip][j] + K1_10*FE0_f0_D01[ip][j]))*n10 + ((K1_01*FE0_f0_D10[ip][j] + K1_11*FE0_f0_D01[ip][j]))*n11))*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[((j + 6))*12 + (k + 6)] += ((((((((K1_01*K1_01*FE0_f0_D20[ip][k] + K1_01*K1_11*FE0_f0_D11[ip][k] + K1_11*K1_01*FE0_f0_D11[ip][k] + K1_11*K1_11*FE0_f0_D02[ip][k]) + (K1_00*K1_00*FE0_f0_D20[ip][k] + K1_00*K1_10*FE0_f0_D11[ip][k] + K1_10*K1_00*FE0_f0_D11[ip][k] + K1_10*K1_10*FE0_f0_D02[ip][k])))*0.500000000000000)*((((K1_00*FE0_f0_D10[ip][j] + K1_10*FE0_f0_D01[ip][j]))*n10 + ((K1_01*FE0_f0_D10[ip][j] + K1_11*FE0_f0_D01[ip][j]))*n11)))*(-1.000000000000000) + (((((K1_01*K1_01*FE0_f0_D20[ip][j] + K1_01*K1_11*FE0_f0_D11[ip][j] + K1_11*K1_01*FE0_f0_D11[ip][j] + K1_11*K1_11*FE0_f0_D02[ip][j]) + (K1_00*K1_00*FE0_f0_D20[ip][j] + K1_00*K1_10*FE0_f0_D11[ip][j] + K1_10*K1_00*FE0_f0_D11[ip][j] + K1_10*K1_10*FE0_f0_D02[ip][j])))*0.500000000000000)*((((K1_00*FE0_f0_D10[ip][k] + K1_10*FE0_f0_D01[ip][k]))*n10 + ((K1_01*FE0_f0_D10[ip][k] + K1_11*FE0_f0_D01[ip][k]))*n11)))*(-1.000000000000000)) + (((((K1_00*FE0_f0_D10[ip][j] + K1_10*FE0_f0_D01[ip][j]))*n10 + ((K1_01*FE0_f0_D10[ip][j] + K1_11*FE0_f0_D01[ip][j]))*n11))*((((K1_00*FE0_f0_D10[ip][k] + K1_10*FE0_f0_D01[ip][k]))*n10 + ((K1_01*FE0_f0_D10[ip][k] + K1_11*FE0_f0_D01[ip][k]))*n11)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[j*12 + (k + 6)] += ((((((((K0_01*K0_01*FE0_f2_D20[ip][j] + K0_01*K0_11*FE0_f2_D11[ip][j] + K0_11*K0_01*FE0_f2_D11[ip][j] + K0_11*K0_11*FE0_f2_D02[ip][j]) + (K0_00*K0_00*FE0_f2_D20[ip][j] + K0_00*K0_10*FE0_f2_D11[ip][j] + K0_10*K0_00*FE0_f2_D11[ip][j] + K0_10*K0_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K1_00*FE0_f0_D10[ip][k] + K1_10*FE0_f0_D01[ip][k]))*n10 + ((K1_01*FE0_f0_D10[ip][k] + K1_11*FE0_f0_D01[ip][k]))*n11)))*(-1.000000000000000) + (((((K1_01*K1_01*FE0_f0_D20[ip][k] + K1_01*K1_11*FE0_f0_D11[ip][k] + K1_11*K1_01*FE0_f0_D11[ip][k] + K1_11*K1_11*FE0_f0_D02[ip][k]) + (K1_00*K1_00*FE0_f0_D20[ip][k] + K1_00*K1_10*FE0_f0_D11[ip][k] + K1_10*K1_00*FE0_f0_D11[ip][k] + K1_10*K1_10*FE0_f0_D02[ip][k])))*0.500000000000000)*((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01)))*(-1.000000000000000)) + (((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01))*((((K1_00*FE0_f0_D10[ip][k] + K1_10*FE0_f0_D01[ip][k]))*n10 + ((K1_01*FE0_f0_D10[ip][k] + K1_11*FE0_f0_D01[ip][k]))*n11)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[j*12 + k] += ((((((((K0_01*K0_01*FE0_f2_D20[ip][j] + K0_01*K0_11*FE0_f2_D11[ip][j] + K0_11*K0_01*FE0_f2_D11[ip][j] + K0_11*K0_11*FE0_f2_D02[ip][j]) + (K0_00*K0_00*FE0_f2_D20[ip][j] + K0_00*K0_10*FE0_f2_D11[ip][j] + K0_10*K0_00*FE0_f2_D11[ip][j] + K0_10*K0_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(-1.000000000000000) + (((((K0_01*K0_01*FE0_f2_D20[ip][k] + K0_01*K0_11*FE0_f2_D11[ip][k] + K0_11*K0_01*FE0_f2_D11[ip][k] + K0_11*K0_11*FE0_f2_D02[ip][k]) + (K0_00*K0_00*FE0_f2_D20[ip][k] + K0_00*K0_10*FE0_f2_D11[ip][k] + K0_10*K0_00*FE0_f2_D11[ip][k] + K0_10*K0_10*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01)))*(-1.000000000000000)) + (((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01))*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
            }// end loop over 'k'
          }// end loop over 'j'
        }// end loop over 'ip'
          break;
      ...
      case 1:
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 6; j++)
          {
            ...
            {
              // Number of operations to compute entry: 96
              A[((j + 6))*12 + k] += ((((((((K1_01*K1_01*FE0_f0_D20[ip][j] + K1_01*K1_11*FE0_f0_D11[ip][j] + K1_11*K1_01*FE0_f0_D11[ip][j] + K1_11*K1_11*FE0_f0_D02[ip][j]) + (K1_00*K1_00*FE0_f0_D20[ip][j] + K1_00*K1_10*FE0_f0_D11[ip][j] + K1_10*K1_00*FE0_f0_D11[ip][j] + K1_10*K1_10*FE0_f0_D02[ip][j])))*0.500000000000000)*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(-1.000000000000000) + (((((K0_01*K0_01*FE0_f2_D20[ip][k] + K0_01*K0_11*FE0_f2_D11[ip][k] + K0_11*K0_01*FE0_f2_D11[ip][k] + K0_11*K0_11*FE0_f2_D02[ip][k]) + (K0_00*K0_00*FE0_f2_D20[ip][k] + K0_00*K0_10*FE0_f2_D11[ip][k] + K0_10*K0_00*FE0_f2_D11[ip][k] + K0_10*K0_10*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K1_00*FE0_f1_D10[ip][j] + K1_10*FE0_f1_D01[ip][j]))*n10 + ((K1_01*FE0_f1_D10[ip][j] + K1_11*FE0_f1_D01[ip][j]))*n11)))*(-1.000000000000000)) + (((((K1_00*FE0_f1_D10[ip][j] + K1_10*FE0_f1_D01[ip][j]))*n10 + ((K1_01*FE0_f1_D10[ip][j] + K1_11*FE0_f1_D01[ip][j]))*n11))*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[((j + 6))*12 + (k + 6)] += ((((((((K1_01*K1_01*FE0_f0_D20[ip][j] + K1_01*K1_11*FE0_f0_D11[ip][j] + K1_11*K1_01*FE0_f0_D11[ip][j] + K1_11*K1_11*FE0_f0_D02[ip][j]) + (K1_00*K1_00*FE0_f0_D20[ip][j] + K1_00*K1_10*FE0_f0_D11[ip][j] + K1_10*K1_00*FE0_f0_D11[ip][j] + K1_10*K1_10*FE0_f0_D02[ip][j])))*0.500000000000000)*((((K1_01*FE0_f1_D10[ip][k] + K1_11*FE0_f1_D01[ip][k]))*n11 + ((K1_00*FE0_f1_D10[ip][k] + K1_10*FE0_f1_D01[ip][k]))*n10)))*(-1.000000000000000) + (((((K1_01*K1_01*FE0_f0_D20[ip][k] + K1_01*K1_11*FE0_f0_D11[ip][k] + K1_11*K1_01*FE0_f0_D11[ip][k] + K1_11*K1_11*FE0_f0_D02[ip][k]) + (K1_00*K1_00*FE0_f0_D20[ip][k] + K1_00*K1_10*FE0_f0_D11[ip][k] + K1_10*K1_00*FE0_f0_D11[ip][k] + K1_10*K1_10*FE0_f0_D02[ip][k])))*0.500000000000000)*((((K1_00*FE0_f1_D10[ip][j] + K1_10*FE0_f1_D01[ip][j]))*n10 + ((K1_01*FE0_f1_D10[ip][j] + K1_11*FE0_f1_D01[ip][j]))*n11)))*(-1.000000000000000)) + (((((K1_00*FE0_f1_D10[ip][j] + K1_10*FE0_f1_D01[ip][j]))*n10 + ((K1_01*FE0_f1_D10[ip][j] + K1_11*FE0_f1_D01[ip][j]))*n11))*((((K1_01*FE0_f1_D10[ip][k] + K1_11*FE0_f1_D01[ip][k]))*n11 + ((K1_00*FE0_f1_D10[ip][k] + K1_10*FE0_f1_D01[ip][k]))*n10)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[j*12 + (k + 6)] += ((((((((K0_01*K0_01*FE0_f2_D20[ip][j] + K0_01*K0_11*FE0_f2_D11[ip][j] + K0_11*K0_01*FE0_f2_D11[ip][j] + K0_11*K0_11*FE0_f2_D02[ip][j]) + (K0_00*K0_00*FE0_f2_D20[ip][j] + K0_00*K0_10*FE0_f2_D11[ip][j] + K0_10*K0_00*FE0_f2_D11[ip][j] + K0_10*K0_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K1_01*FE0_f1_D10[ip][k] + K1_11*FE0_f1_D01[ip][k]))*n11 + ((K1_00*FE0_f1_D10[ip][k] + K1_10*FE0_f1_D01[ip][k]))*n10)))*(-1.000000000000000) + (((((K1_01*K1_01*FE0_f0_D20[ip][k] + K1_01*K1_11*FE0_f0_D11[ip][k] + K1_11*K1_01*FE0_f0_D11[ip][k] + K1_11*K1_11*FE0_f0_D02[ip][k]) + (K1_00*K1_00*FE0_f0_D20[ip][k] + K1_00*K1_10*FE0_f0_D11[ip][k] + K1_10*K1_00*FE0_f0_D11[ip][k] + K1_10*K1_10*FE0_f0_D02[ip][k])))*0.500000000000000)*((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01)))*(-1.000000000000000)) + (((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01))*((((K1_01*FE0_f1_D10[ip][k] + K1_11*FE0_f1_D01[ip][k]))*n11 + ((K1_00*FE0_f1_D10[ip][k] + K1_10*FE0_f1_D01[ip][k]))*n10)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[j*12 + k] += ((((((((K0_01*K0_01*FE0_f2_D20[ip][j] + K0_01*K0_11*FE0_f2_D11[ip][j] + K0_11*K0_01*FE0_f2_D11[ip][j] + K0_11*K0_11*FE0_f2_D02[ip][j]) + (K0_00*K0_00*FE0_f2_D20[ip][j] + K0_00*K0_10*FE0_f2_D11[ip][j] + K0_10*K0_00*FE0_f2_D11[ip][j] + K0_10*K0_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(-1.000000000000000) + (((((K0_01*K0_01*FE0_f2_D20[ip][k] + K0_01*K0_11*FE0_f2_D11[ip][k] + K0_11*K0_01*FE0_f2_D11[ip][k] + K0_11*K0_11*FE0_f2_D02[ip][k]) + (K0_00*K0_00*FE0_f2_D20[ip][k] + K0_00*K0_10*FE0_f2_D11[ip][k] + K0_10*K0_00*FE0_f2_D11[ip][k] + K0_10*K0_10*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01)))*(-1.000000000000000)) + (((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01))*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
            }// end loop over 'k'
          }// end loop over 'j'
      ...
      case 2:
        ...
        for (unsigned int ip = 0; ip < 2; ip++)
        {
          ...
          for (unsigned int j = 0; j < 6; j++)
          {
            ...
            {
              // Number of operations to compute entry: 96
              A[((j + 6))*12 + k] += ((((((((K1_01*K1_01*FE0_f2_D20[ip][j] + K1_01*K1_11*FE0_f2_D11[ip][j] + K1_11*K1_01*FE0_f2_D11[ip][j] + K1_11*K1_11*FE0_f2_D02[ip][j]) + (K1_00*K1_00*FE0_f2_D20[ip][j] + K1_00*K1_10*FE0_f2_D11[ip][j] + K1_10*K1_00*FE0_f2_D11[ip][j] + K1_10*K1_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(-1.000000000000000) + (((((K0_01*K0_01*FE0_f2_D20[ip][k] + K0_01*K0_11*FE0_f2_D11[ip][k] + K0_11*K0_01*FE0_f2_D11[ip][k] + K0_11*K0_11*FE0_f2_D02[ip][k]) + (K0_00*K0_00*FE0_f2_D20[ip][k] + K0_00*K0_10*FE0_f2_D11[ip][k] + K0_10*K0_00*FE0_f2_D11[ip][k] + K0_10*K0_10*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K1_00*FE0_f2_D10[ip][j] + K1_10*FE0_f2_D01[ip][j]))*n10 + ((K1_01*FE0_f2_D10[ip][j] + K1_11*FE0_f2_D01[ip][j]))*n11)))*(-1.000000000000000)) + (((((K1_00*FE0_f2_D10[ip][j] + K1_10*FE0_f2_D01[ip][j]))*n10 + ((K1_01*FE0_f2_D10[ip][j] + K1_11*FE0_f2_D01[ip][j]))*n11))*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[((j + 6))*12 + (k + 6)] += ((((((((K1_01*K1_01*FE0_f2_D20[ip][j] + K1_01*K1_11*FE0_f2_D11[ip][j] + K1_11*K1_01*FE0_f2_D11[ip][j] + K1_11*K1_11*FE0_f2_D02[ip][j]) + (K1_00*K1_00*FE0_f2_D20[ip][j] + K1_00*K1_10*FE0_f2_D11[ip][j] + K1_10*K1_00*FE0_f2_D11[ip][j] + K1_10*K1_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K1_01*FE0_f2_D10[ip][k] + K1_11*FE0_f2_D01[ip][k]))*n11 + ((K1_00*FE0_f2_D10[ip][k] + K1_10*FE0_f2_D01[ip][k]))*n10)))*(-1.000000000000000) + (((((K1_00*K1_00*FE0_f2_D20[ip][k] + K1_00*K1_10*FE0_f2_D11[ip][k] + K1_10*K1_00*FE0_f2_D11[ip][k] + K1_10*K1_10*FE0_f2_D02[ip][k]) + (K1_01*K1_01*FE0_f2_D20[ip][k] + K1_01*K1_11*FE0_f2_D11[ip][k] + K1_11*K1_01*FE0_f2_D11[ip][k] + K1_11*K1_11*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K1_00*FE0_f2_D10[ip][j] + K1_10*FE0_f2_D01[ip][j]))*n10 + ((K1_01*FE0_f2_D10[ip][j] + K1_11*FE0_f2_D01[ip][j]))*n11)))*(-1.000000000000000)) + (((((K1_00*FE0_f2_D10[ip][j] + K1_10*FE0_f2_D01[ip][j]))*n10 + ((K1_01*FE0_f2_D10[ip][j] + K1_11*FE0_f2_D01[ip][j]))*n11))*((((K1_01*FE0_f2_D10[ip][k] + K1_11*FE0_f2_D01[ip][k]))*n11 + ((K1_00*FE0_f2_D10[ip][k] + K1_10*FE0_f2_D01[ip][k]))*n10)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[j*12 + (k + 6)] += ((((((((K0_01*K0_01*FE0_f2_D20[ip][j] + K0_01*K0_11*FE0_f2_D11[ip][j] + K0_11*K0_01*FE0_f2_D11[ip][j] + K0_11*K0_11*FE0_f2_D02[ip][j]) + (K0_00*K0_00*FE0_f2_D20[ip][j] + K0_00*K0_10*FE0_f2_D11[ip][j] + K0_10*K0_00*FE0_f2_D11[ip][j] + K0_10*K0_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K1_01*FE0_f2_D10[ip][k] + K1_11*FE0_f2_D01[ip][k]))*n11 + ((K1_00*FE0_f2_D10[ip][k] + K1_10*FE0_f2_D01[ip][k]))*n10)))*(-1.000000000000000) + (((((K1_00*K1_00*FE0_f2_D20[ip][k] + K1_00*K1_10*FE0_f2_D11[ip][k] + K1_10*K1_00*FE0_f2_D11[ip][k] + K1_10*K1_10*FE0_f2_D02[ip][k]) + (K1_01*K1_01*FE0_f2_D20[ip][k] + K1_01*K1_11*FE0_f2_D11[ip][k] + K1_11*K1_01*FE0_f2_D11[ip][k] + K1_11*K1_11*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01)))*(-1.000000000000000)) + (((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01))*((((K1_01*FE0_f2_D10[ip][k] + K1_11*FE0_f2_D01[ip][k]))*n11 + ((K1_00*FE0_f2_D10[ip][k] + K1_10*FE0_f2_D01[ip][k]))*n10)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
              // Number of operations to compute entry: 96
              A[j*12 + k] += ((((((((K0_01*K0_01*FE0_f2_D20[ip][j] + K0_01*K0_11*FE0_f2_D11[ip][j] + K0_11*K0_01*FE0_f2_D11[ip][j] + K0_11*K0_11*FE0_f2_D02[ip][j]) + (K0_00*K0_00*FE0_f2_D20[ip][j] + K0_00*K0_10*FE0_f2_D11[ip][j] + K0_10*K0_00*FE0_f2_D11[ip][j] + K0_10*K0_10*FE0_f2_D02[ip][j])))*0.500000000000000)*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(-1.000000000000000) + (((((K0_01*K0_01*FE0_f2_D20[ip][k] + K0_01*K0_11*FE0_f2_D11[ip][k] + K0_11*K0_01*FE0_f2_D11[ip][k] + K0_11*K0_11*FE0_f2_D02[ip][k]) + (K0_00*K0_00*FE0_f2_D20[ip][k] + K0_00*K0_10*FE0_f2_D11[ip][k] + K0_10*K0_00*FE0_f2_D11[ip][k] + K0_10*K0_10*FE0_f2_D02[ip][k])))*0.500000000000000)*((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01)))*(-1.000000000000000)) + (((((K0_00*FE0_f2_D10[ip][j] + K0_10*FE0_f2_D01[ip][j]))*n00 + ((K0_01*FE0_f2_D10[ip][j] + K0_11*FE0_f2_D01[ip][j]))*n01))*((((K0_01*FE0_f2_D10[ip][k] + K0_11*FE0_f2_D01[ip][k]))*n01 + ((K0_00*FE0_f2_D10[ip][k] + K0_10*FE0_f2_D01[ip][k]))*n00)))*(w[1][0]/((w[0][0] + w[0][1])/(2.000000000000000)))))*W2[ip]*det;
            }// end loop over 'k'
          }// end loop over 'j'
