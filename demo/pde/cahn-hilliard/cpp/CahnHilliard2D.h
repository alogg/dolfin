...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    double G[9];
    G[0] = -12.000000000000000*det*w[2][0];
    G[1] = 12.000000000000000*det*w[2][0];
    G[2] = -2.000000000000000*det*w[2][0];
    G[3] =  - det*w[1][0]*(K_00*K_10 + K_01*K_11);
    G[4] =  - det*w[1][0]*(K_10*K_10 + K_11*K_11);
    G[5] = det*w[3][0]*w[4][0]*(K_10*K_10 + K_11*K_11);
    G[6] = det*w[3][0]*w[4][0]*(K_00*K_10 + K_01*K_11);
    G[7] = det*w[3][0]*w[4][0]*(K_00*K_00 + K_01*K_01);
    G[8] =  - det*w[1][0]*(K_00*K_00 + K_01*K_01);
    ...
    for (unsigned int ip = 0; ip < 9; ip++)
    {
      ...
      for (unsigned int j = 0; j < 3; j++)
      {
        for (unsigned int k = 0; k < 3; k++)
        {
          ...
          A[nzc0[j]*6 + nzc3[k]] += FE1_C0[ip][j]*FE1_C0[ip][k]*I[0];
          // Number of operations to compute entry: 3
          A[nzc3[j]*6 + nzc3[k]] += FE1_C0[ip][j]*FE1_C0[ip][k]*I[1];
          // Number of operations to compute entry: 3
          A[nzc3[j]*6 + nzc0[k]] += FE1_C0[ip][j]*FE1_C0[ip][k]*I[0];
        }// end loop over 'k'
      }// end loop over 'j'
      ...
      for (unsigned int j = 0; j < 2; j++)
      {
        ...
        {
          // Number of operations to compute entry: 3
          A[nzc5[j]*6 + nzc4[k]] += FE1_C0_D01[ip][j]*FE1_C0_D01[ip][k]*I[2];
          // Number of operations to compute entry: 3
          A[nzc4[j]*6 + nzc4[k]] += FE1_C0_D01[ip][j]*FE1_C0_D01[ip][k]*I[3];
          // Number of operations to compute entry: 3
          A[nzc1[j]*6 + nzc1[k]] += FE1_C0_D01[ip][j]*FE1_C0_D01[ip][k]*I[4];
          // Number of operations to compute entry: 3
          A[nzc1[j]*6 + nzc2[k]] += FE1_C0_D01[ip][j]*FE1_C0_D01[ip][k]*I[5];
          // Number of operations to compute entry: 3
          A[nzc2[j]*6 + nzc1[k]] += FE1_C0_D01[ip][j]*FE1_C0_D01[ip][k]*I[5];
          // Number of operations to compute entry: 3
          A[nzc4[j]*6 + nzc5[k]] += FE1_C0_D01[ip][j]*FE1_C0_D01[ip][k]*I[2];
          // Number of operations to compute entry: 3
          A[nzc2[j]*6 + nzc2[k]] += FE1_C0_D01[ip][j]*FE1_C0_D01[ip][k]*I[6];
          // Number of operations to compute entry: 3
          A[nzc5[j]*6 + nzc5[k]] += FE1_C0_D01[ip][j]*FE1_C0_D01[ip][k]*I[7];
        }// end loop over 'k'
      }// end loop over 'j'
    }// end loop over 'ip'
  }
...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Number of operations to compute geometry constants: 67.
    double G[12];
    G[0] = 6.000000000000000*det*w[3][0];
    G[1] = -4.000000000000000*det*w[3][0];
    G[2] = -2.000000000000000*det*w[3][0];
    G[3] = det*w[4][0]*(K_00*K_00 + K_01*K_01 - w[5][0]*(K_00*K_00 + K_01*K_01));
    G[4] = det*w[4][0]*(K_00*K_10*(1.000000000000000 - w[5][0]) + K_01*K_11*(1.000000000000000 - w[5][0]));
    G[5] = det*w[4][0]*w[5][0]*(K_00*K_00 + K_01*K_01);
    G[6] = det*w[4][0]*w[5][0]*(K_00*K_10 + K_01*K_11);
    G[7] =  - det*w[2][0]*(K_00*K_00 + K_01*K_01);
    G[8] =  - det*w[2][0]*(K_00*K_10 + K_01*K_11);
    G[9] =  - det*w[2][0]*(K_10*K_10 + K_11*K_11);
    G[10] = det*w[4][0]*(K_10*K_10*(1.000000000000000 - w[5][0]) + K_11*K_11*(1.000000000000000 - w[5][0]));
    G[11] = det*w[4][0]*w[5][0]*(K_10*K_10 + K_11*K_11);
