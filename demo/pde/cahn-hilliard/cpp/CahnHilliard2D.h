...
public:
  ...
  /// Constructor
  cahnhilliard2d_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }
...
public:
  ...
  /// Constructor
  cahnhilliard2d_finite_element_1() : ufc::finite_element()
  {
    // Do nothing
  }
...
public:
  ...
  /// Constructor
  cahnhilliard2d_finite_element_2() : ufc::finite_element()
  {
    // Do nothing
  }
...
public:
  ...
  /// Constructor
  cahnhilliard2d_dof_map_0() : ufc::dof_map()
  {
    _global_dimension = 0;
  }
...
public:
  ...
  /// Constructor
  cahnhilliard2d_dof_map_1() : ufc::dof_map()
  {
    _global_dimension = 0;
  }
...
public:
  ...
  /// Constructor
  cahnhilliard2d_dof_map_2() : ufc::dof_map()
  {
    _global_dimension = 0;
  }
...
public:
  ...
  /// Constructor
  cahnhilliard2d_cell_integral_0_0() : ufc::cell_integral()
  {
    // Do nothing
  }
                               ...
                               const ufc::cell& c) const
  {
    ...
    {{0.808694385677670, 0.102717654809626, 0.088587959512704, 0.000000000000000, 0.000000000000000, 0.000000000000000},
    {0.523979067720101, 0.066554067839165, 0.409466864440735, 0.000000000000000, 0.000000000000000, 0.000000000000000},
    {0.188409405952072, 0.023931132287081, 0.787659461760847, 0.000000000000000, 0.000000000000000, 0.000000000000000},
    {0.455706020243648, 0.455706020243648, 0.088587959512704, 0.000000000000000, 0.000000000000000, 0.000000000000000},
    {0.295266567779633, 0.295266567779633, 0.409466864440735, 0.000000000000000, 0.000000000000000, 0.000000000000000},
    {0.106170269119576, 0.106170269119577, 0.787659461760847, 0.000000000000000, 0.000000000000000, 0.000000000000000},
    {0.102717654809626, 0.808694385677670, 0.088587959512704, 0.000000000000000, 0.000000000000000, 0.000000000000000},
    {0.066554067839164, 0.523979067720101, 0.409466864440735, 0.000000000000000, 0.000000000000000, 0.000000000000000},
    {0.023931132287081, 0.188409405952072, 0.787659461760847, 0.000000000000000, 0.000000000000000, 0.000000000000000}};
    
    static const double FE1_C0_D01[9][6] = \
    ...
    static const double FE1_C0_D10[9][6] = \
    ...
    static const double FE1_C1[9][6] = \
    {{0.000000000000000, 0.000000000000000, 0.000000000000000, 0.808694385677670, 0.102717654809626, 0.088587959512704},
    {0.000000000000000, 0.000000000000000, 0.000000000000000, 0.523979067720101, 0.066554067839165, 0.409466864440735},
    {0.000000000000000, 0.000000000000000, 0.000000000000000, 0.188409405952072, 0.023931132287081, 0.787659461760847},
    {0.000000000000000, 0.000000000000000, 0.000000000000000, 0.455706020243648, 0.455706020243648, 0.088587959512704},
    {0.000000000000000, 0.000000000000000, 0.000000000000000, 0.295266567779633, 0.295266567779633, 0.409466864440735},
    {0.000000000000000, 0.000000000000000, 0.000000000000000, 0.106170269119576, 0.106170269119577, 0.787659461760847},
    {0.000000000000000, 0.000000000000000, 0.000000000000000, 0.102717654809626, 0.808694385677670, 0.088587959512704},
    {0.000000000000000, 0.000000000000000, 0.000000000000000, 0.066554067839164, 0.523979067720101, 0.409466864440735},
    {0.000000000000000, 0.000000000000000, 0.000000000000000, 0.023931132287081, 0.188409405952072, 0.787659461760847}};
    
    static const double FE1_C1_D01[9][6] = \
    ...
    static const double FE1_C1_D10[9][6] = \
    ...
    // Number of operations to compute element tensor for following IP loop = 25380
    for (unsigned int ip = 0; ip < 9; ip++)
    {
      ...
      for (unsigned int j = 0; j < 6; j++)
      {
        for (unsigned int k = 0; k < 6; k++)
        {
          ...
          A[j*6 + k] += (((FE1_C0[ip][j]*FE1_C1[ip][k] + ((((K_01*FE1_C0_D10[ip][j] + K_11*FE1_C0_D01[ip][j]))*(((K_01*FE1_C0_D10[ip][k] + K_11*FE1_C0_D01[ip][k]))*w[4][0]) + ((K_00*FE1_C0_D10[ip][j] + K_10*FE1_C0_D01[ip][j]))*(((K_00*FE1_C0_D10[ip][k] + K_10*FE1_C0_D01[ip][k]))*w[4][0])))*w[3][0]) + ((((((K_00*FE1_C1_D10[ip][j] + K_10*FE1_C1_D01[ip][j]))*((K_00*FE1_C1_D10[ip][k] + K_10*FE1_C1_D01[ip][k])) + ((K_01*FE1_C1_D10[ip][j] + K_11*FE1_C1_D01[ip][j]))*((K_01*FE1_C1_D10[ip][k] + K_11*FE1_C1_D01[ip][k]))))*w[1][0])*(-1.000000000000000) + (FE1_C1[ip][j]*FE1_C0[ip][k] + (FE1_C1[ip][j]*(((((2.000000000000000*FE1_C1[ip][k]*2.000000000000000*F0*(((-1.000000000000000)*F0 + 1.000000000000000)) + (FE1_C1[ip][k]*(-1.000000000000000))*F0*2.000000000000000*F0))*(-1.000000000000000) + ((FE1_C1[ip][k]*(-1.000000000000000))*(2.000000000000000*F0*(((-1.000000000000000)*F0 + 1.000000000000000))) + ((FE1_C1[ip][k]*2.000000000000000*(((-1.000000000000000)*F0 + 1.000000000000000)) + (FE1_C1[ip][k]*(-1.000000000000000))*2.000000000000000*F0))*(((-1.000000000000000)*F0 + 1.000000000000000)))))*w[2][0]))*(-1.000000000000000)))))*W9[ip]*det;
        }// end loop over 'k'
      }// end loop over 'j'
    }// end loop over 'ip'
  }
...
public:
  ...
  /// Constructor
  cahnhilliard2d_cell_integral_1_0() : ufc::cell_integral()
  {
    // Do nothing
  }
                               ...
                               const ufc::cell& c) const
  {
    ...
    for (unsigned int ip = 0; ip < 9; ip++)
    {
      ...
      {
        // Number of operations to compute entry: 78
        A[j] += ((((FE1_C0[ip][j]*F5*(-1.000000000000000) + FE1_C0[ip][j]*F4) + ((((K_01*FE1_C0_D10[ip][j] + K_11*FE1_C0_D01[ip][j]))*((((K_01*F2 + K_11*F3))*(((-1.000000000000000)*w[5][0] + 1.000000000000000)) + w[5][0]*((K_01*F0 + K_11*F1)))) + ((K_00*FE1_C0_D10[ip][j] + K_10*FE1_C0_D01[ip][j]))*((((K_00*F2 + K_10*F3))*(((-1.000000000000000)*w[5][0] + 1.000000000000000)) + w[5][0]*((K_00*F0 + K_10*F1))))))*w[4][0]) + ((FE1_C1[ip][j]*F8 + (FE1_C1[ip][j]*(w[3][0]*(((2.000000000000000*F4*(((-1.000000000000000)*F4 + 1.000000000000000)))*(((-1.000000000000000)*F4 + 1.000000000000000)) + (-1.000000000000000)*(F4*2.000000000000000*F4*(((-1.000000000000000)*F4 + 1.000000000000000)))))))*(-1.000000000000000)) + (((((K_01*FE1_C1_D10[ip][j] + K_11*FE1_C1_D01[ip][j]))*((K_01*F6 + K_11*F7)) + ((K_00*FE1_C1_D10[ip][j] + K_10*FE1_C1_D01[ip][j]))*((K_00*F6 + K_10*F7))))*w[2][0])*(-1.000000000000000))))*W9[ip]*det;
      }// end loop over 'j'
    }// end loop over 'ip'
  }
...
public:
  ...
  /// Constructor
  cahnhilliard2d_form_0() : ufc::form()
  {
    // Do nothing
  }
...
public:
  ...
  /// Constructor
  cahnhilliard2d_form_1() : ufc::form()
  {
    // Do nothing
  }
