...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    {0.589129380761496, 2.23477754271068, 0.354351838050816, -0.354351838050816, -2.82390692347217},
    ...
    {0.246362376191711, 2.15063784704339, 0.0957245291483228, -2.3970002232351, -0.0957245291483229},
    ...
    {-0.0576951799472842, 0.0251290590975512, -0.0741406382908806, 0.858208263567716, 0.109006741895515, 0.139491753677383},
    ...
    const double G1 = det*(2*Jinv_00*Jinv_10 + 2*Jinv_01*Jinv_11);
    ...
    // Total number of operations to compute element tensor: 410
    ...
    for (unsigned int ip = 0; ip < 9; ip++)
    {
      ...
      const double Gip0 = W9[ip]*(F0*F0*det + F1*F1*G2 + F2*(F1*G1 + F2*G0));
...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(Sum(IndexSum(Product(Indexed(ComponentTensor(SpatialDerivative(Function(FiniteElement('Lagrange', Cell('triangle', 1), 2), 0), MultiIndex((Index(0),), {Index(0): 2})), MultiIndex((Index(0),), {Index(0): 2})), MultiIndex((Index(1),), {Index(1): 2})), Indexed(ComponentTensor(SpatialDerivative(Function(FiniteElement('Lagrange', Cell('triangle', 1), 2), 0), MultiIndex((Index(2),), {Index(2): 2})), MultiIndex((Index(2),), {Index(2): 2})), MultiIndex((Index(1),), {Index(1): 2}))), MultiIndex((Index(1),), {Index(1): 2})), Power(Function(FiniteElement('Lagrange', Cell('triangle', 1), 2), 0), IntValue(2, (), (), {}))), Measure('cell', 0, None))])";
  }
