...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    {-0.181066271118531, 0.637867457762939, 1.181066271118531, -0.456801186644409, -1.181066271118531},
    ...
    {{-2.234777542710679, -0.589129380761495, 0.354351838050815, -0.354351838050816, 2.823906923472174},
    ...
    const double G0 = det*(K_00*K_00 + K_01*K_01);
    const double G1 = 2.000000000000000*det*(K_00*K_10 + K_01*K_11);
