...
public:
  ...
  EnergyNormFunctional(dolfin::Function& v0) : dolfin::Form()
  {
  ...
  EnergyNormFunctional(std::tr1::shared_ptr<dolfin::Function> v0) : dolfin::Form()
  {
