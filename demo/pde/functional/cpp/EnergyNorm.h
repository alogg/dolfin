...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    static const double FE0_D01[9][6] = \
    ...
    {-0.181066271118531, 0.000000000000000, 0.637867457762939, 1.181066271118531, -0.456801186644409, -1.181066271118531},
    ...
    static const double FE0_D10[9][6] = \
    {{-2.234777542710679, -0.589129380761495, 0.000000000000000, 0.354351838050815, -0.354351838050816, 2.823906923472174},
    ...
    for (unsigned int ip = 0; ip < 9; ip++)
    {
      ...
      A[0] += ((F2*F2 + (((K_00*F0 + K_10*F1))*((K_00*F0 + K_10*F1)) + ((K_01*F0 + K_11*F1))*((K_01*F0 + K_11*F1)))))*W9[ip]*det;
    }// end loop over 'ip'
  }
