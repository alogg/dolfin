...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Number of operations to compute element tensor = 250
    ...
    // Number of operations to compute tensor = 232
    ...
    A[10] = -0.0416666666666666*G0_0_0 + 0.0833333333333332*G0_0_1 + 0.25*G0_1_0 - 0.333333333333333*G0_1_1;
    A[11] = 0.0833333333333332*G0_0_0 - 0.0833333333333332*G0_1_0 - 0.0833333333333331*G0_1_1;
    A[12] = -0.166666666666666*G0_0_0 + 0.125*G0_0_1 + 0.166666666666666*G0_1_0 - 0.0833333333333332*G0_1_1;
    A[13] = -0.5*G1_;
    ...
    A[21] = 0.0833333333333331*G0_0_0 - 0.125*G0_0_1 - 0.166666666666666*G0_1_0 + 0.166666666666666*G0_1_1;
    ...
    A[26] = 0.0833333333333331*G0_0_0 - 0.0833333333333331*G0_0_1 - 0.166666666666666*G0_1_0 + 0.0833333333333332*G0_1_1;
    A[27] = 0.5*G1_;
    ...
    A[31] = -0.0416666666666666*G0_0_0 + 0.0833333333333332*G0_0_1 + 0.0416666666666666*G0_1_0 + 0.0833333333333331*G0_1_1;
    ...
    A[38] = 0.0833333333333331*G0_0_0 - 0.166666666666666*G0_0_1 - 0.0833333333333331*G0_1_0 + 0.0833333333333331*G0_1_1;
...
public:
  ...
  MixedPoissonBilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form()
  {
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_MixedPoissonBilinearForm());
  }

  // Create form on given function space(s) (shared data)
  MixedPoissonBilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form()
  {
...
public:
  ...
  MixedPoissonLinearForm(const dolfin::FunctionSpace& V0) : dolfin::Form(), f(*this)
  {
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_MixedPoissonLinearForm());
  }

  // Create form on given function space(s) (shared data)
  MixedPoissonLinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0) : dolfin::Form(), f(*this)
  {
    _function_spaces.push_back(V0);
  ...
  MixedPoissonLinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, dolfin::Function& w0) : dolfin::Form(), f(*this)
  {
    _function_spaces.push_back(V0);
