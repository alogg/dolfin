...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Array of quadrature weights (tensor/monomial term 0)
    const static double W0[4] = {0.159020690871988, 0.0909793091280112, 0.159020690871988, 0.0909793091280112};
    
    const static double P_t0_p0[4][3] = \
    ...
    for (unsigned int ip = 0; ip < 4; ip++)
    {
      ...
      {
        F0 += P_t0_p0[ip][r]*w[0][r];
      }// end loop over 'r'
      
      // Number of operations to compute declarations = 2
