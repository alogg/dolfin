...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(Product(Function(FiniteElement('Lagrange', Cell('triangle', 1, Space(2)), 1), 0), Indexed(VectorConstant(Cell('triangle', 1, Space(2)), 2, 1), MultiIndex((FixedIndex(1),), {FixedIndex(1): 2}))), Measure('exterior_facet', 0, None))])";
  }
...
public:
  ...
  CoefficientSpace_n(const dolfin::Mesh & mesh):
      dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                            ...
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new lift_0_dof_map_1()), dolfin::reference_to_no_delete_pointer(mesh))))
  {
    // Do nothing
  }
