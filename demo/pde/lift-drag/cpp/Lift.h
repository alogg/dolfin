...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(Product(Function(FiniteElement('Lagrange', Cell('triangle', 1), 1), 0), Indexed(VectorConstant(Cell('triangle', 1), 2, 1), MultiIndex((FixedIndex(1),), {FixedIndex(1): 2}))), Measure('exterior_facet', 0, None))])";
  }
