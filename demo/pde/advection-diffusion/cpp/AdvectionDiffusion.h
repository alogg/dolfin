...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    const double G0 = 0.025*Jinv_11*det;
    const double G1 = 0.025*Jinv_10*det;
    const double G2 = 0.000125*det*(Jinv_00*Jinv_10 + Jinv_01*Jinv_11);
    const double G3 = 0.000125*det*(Jinv_10*Jinv_10 + Jinv_11*Jinv_11);
    const double G4 = 0.000125*det*(Jinv_00*Jinv_00 + Jinv_01*Jinv_01);
    ...
    // Total number of operations to compute element tensor: 611
    ...
    for (unsigned int ip = 0; ip < 4; ip++)
    {
      ...
      const double Gip1 = W4[ip]*(F0*G1 + F1*G0);
      ...
      // Number of operations: 4
      const double Gip5 = W4[ip]*(F0*G6 + F1*G5);
...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    {-0.123197609346857, -0.0637717752201338, 0.186969384566991, 0.193564950308138, 0.722394229114516, 0.0840408205773458},
    {-0.114792289385376, 0.221761673952367, -0.106969384566991, 0.413297964702014, 0.110742855875331, 0.475959179422654},
    {-0.0637717752201337, -0.123197609346857, 0.186969384566991, 0.722394229114516, 0.193564950308138, 0.0840408205773458}};
    ...
    const double G0 = -0.025*Jinv_00*det;
    const double G1 = -0.025*Jinv_11*det;
    const double G2 = -0.025*Jinv_01*det;
    const double G3 = 0.05*det;
    const double G4 = -0.025*Jinv_10*det;
    const double G5 = -0.000125*det*(Jinv_00*Jinv_00 + Jinv_01*Jinv_01);
    const double G6 = -0.000125*det*(Jinv_00*Jinv_10 + Jinv_01*Jinv_11);
    const double G7 = -0.000125*det*(Jinv_10*Jinv_10 + Jinv_11*Jinv_11);
    
    // Compute element tensor using UFL quadrature representation
    // Optimisations: ('simplify expressions', True), ('ignore zero tables', True), ('non zero columns', True), ('remove zero terms', True), ('ignore ones', True)
    // Total number of operations to compute element tensor: 344
    ...
    for (unsigned int ip = 0; ip < 4; ip++)
    {
      ...
      const double Gip0 = W4[ip]*(F0*G3 + F1*det + F3*(F2*G0 + F5*G2) + F4*(F2*G4 + F5*G1));
...
public:
  ...
  // Constructor
  Form_0(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1, const dolfin::Coefficient& b):
    dolfin::Form(2, 1), b(*this, 0)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
    _function_spaces[1] = reference_to_no_delete_pointer(V1);
  ...
  // Constructor
  Form_0(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1, boost::shared_ptr<const dolfin::Coefficient> b):
    dolfin::Form(2, 1), b(*this, 0)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
    _function_spaces[1] = reference_to_no_delete_pointer(V1);
  ...
  // Constructor
  Form_0(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::FunctionSpace> V1, const dolfin::Coefficient& b):
    dolfin::Form(2, 1), b(*this, 0)
  {
    _function_spaces[0] = V0;
    _function_spaces[1] = V1;
  ...
  // Constructor
  Form_0(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::FunctionSpace> V1, boost::shared_ptr<const dolfin::Coefficient> b):
    dolfin::Form(2, 1), b(*this, 0)
  {
    _function_spaces[0] = V0;
    _function_spaces[1] = V1;
...
public:
  ...
  // Constructor
  Form_1(const dolfin::FunctionSpace& V0, const dolfin::Coefficient& u0, const dolfin::Coefficient& b, const dolfin::Coefficient& f):
    dolfin::Form(1, 3), u0(*this, 0), b(*this, 1), f(*this, 2)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  // Constructor
  Form_1(const dolfin::FunctionSpace& V0, boost::shared_ptr<const dolfin::Coefficient> u0, boost::shared_ptr<const dolfin::Coefficient> b, boost::shared_ptr<const dolfin::Coefficient> f):
    dolfin::Form(1, 3), u0(*this, 0), b(*this, 1), f(*this, 2)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  // Constructor
  Form_1(boost::shared_ptr<const dolfin::FunctionSpace> V0, const dolfin::Coefficient& u0, const dolfin::Coefficient& b, const dolfin::Coefficient& f):
    dolfin::Form(1, 3), u0(*this, 0), b(*this, 1), f(*this, 2)
  {
    _function_spaces[0] = V0;
  ...
  // Constructor
  Form_1(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::Coefficient> u0, boost::shared_ptr<const dolfin::Coefficient> b, boost::shared_ptr<const dolfin::Coefficient> f):
    dolfin::Form(1, 3), u0(*this, 0), b(*this, 1), f(*this, 2)
  {
    _function_spaces[0] = V0;
