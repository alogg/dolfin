...
public:
  ...
  virtual void update_ec(const dolfin::Form& a, const dolfin::Form& L)
  {
    ...
    for (dolfin::uint i = 0; i < a.num_coefficients(); i++)
    {
      ...
      try {
        const uint coefficient_number = a_star->coefficient_number(name);
      } catch (...) {
    ...
    for (dolfin::uint i = 0; i < (*this).num_coefficients(); i++)
    {
      ...
      try {
        const uint coefficient_number = L_star->coefficient_number(name);
      } catch (...) {
    ...
    for (dolfin::uint i = 0; i < a.num_coefficients(); i++)
    {
      ...
      try {
        const uint coefficient_number = residual->coefficient_number(name);
      } catch (...) {
    ...
    for (dolfin::uint i = 0; i < a.num_coefficients(); i++)
    {
      ...
      try {
        const uint coefficient_number = L_R_T->coefficient_number(name);
      } catch (...) {
    ...
    for (dolfin::uint i = 0; i < a.num_coefficients(); i++)
    {
      ...
      try {
        const uint coefficient_number = L_R_dT->coefficient_number(name);
      } catch (...) {
