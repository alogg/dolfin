...
class p1_projection_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  p1_projection_dof_map_0() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~p1_projection_dof_map_0()
  {
    // Do nothing
  }
...
class p1_projection_dof_map_1: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  p1_projection_dof_map_1() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~p1_projection_dof_map_1()
  {
    // Do nothing
  }
...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Total number of operations (multiply-add pairs):                  16
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 0:
      {
        return new p1_projection_dof_map_1();
        break;
      }
    case 1:
      {
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 1:
      {
        return new p1_projection_dof_map_0();
        break;
      }
    }
...
public:
  ...
  CoefficientSpace_f(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          ...
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new p1_projection_dof_map_0()), mesh)))
  {
    // Do nothing
  }
...
public:
  ...
  Form_0_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          ...
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new p1_projection_dof_map_1()), mesh)))
  {
    // Do nothing
  }
