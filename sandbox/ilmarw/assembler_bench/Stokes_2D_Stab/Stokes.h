...
public:
  ...
  // Constructor
  StokesBilinearForm(dolfin::FunctionSpace& V0, dolfin::FunctionSpace& V1) : dolfin::Form(), h(*this)
  {
  ...
  // Constructor
  StokesBilinearForm(std::tr1::shared_ptr<dolfin::FunctionSpace> V0, std::tr1::shared_ptr<dolfin::FunctionSpace> V1) : dolfin::Form(), h(*this)
  {
