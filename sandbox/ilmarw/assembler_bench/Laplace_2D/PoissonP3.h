...
class PoissonP3BilinearFormArgumentSpace0 : public dolfin::FunctionSpace
{
public:

  PoissonP3BilinearFormArgumentSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_PoissonP3LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_PoissonP3LinearForm_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
class PoissonP3BilinearFormArgumentSpace1 : public dolfin::FunctionSpace
{
public:

  PoissonP3BilinearFormArgumentSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_PoissonP3LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_PoissonP3LinearForm_dof_map_1()), mesh)))
  {
...
class PoissonP3LinearFormArgumentSpace0 : public dolfin::FunctionSpace
{
public:

  PoissonP3LinearFormArgumentSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_PoissonP3LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_PoissonP3LinearForm_dof_map_1()), mesh)))
  {
...
public:
  ...
  // Constructor
  PoissonP3BilinearForm(dolfin::FunctionSpace& V0, dolfin::FunctionSpace& V1) : dolfin::Form()
  {
    ...
    _ufc_form = new UFC_PoissonP3BilinearForm();


  }

  // Constructor
  PoissonP3BilinearForm(std::tr1::shared_ptr<dolfin::FunctionSpace> V0, std::tr1::shared_ptr<dolfin::FunctionSpace> V1) : dolfin::Form()
  {
...
public:
  ...
  // Constructor
  PoissonP3LinearForm(dolfin::FunctionSpace& V0) : dolfin::Form(), f(*this)
  {
    std::tr1::shared_ptr<dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<dolfin::FunctionSpace>());
    _function_spaces.push_back(_V0);
    ...
    _ufc_form = new UFC_PoissonP3LinearForm();


  }

  // Constructor
  PoissonP3LinearForm(std::tr1::shared_ptr<dolfin::FunctionSpace> V0) : dolfin::Form(), f(*this)
  {
    _function_spaces.push_back(V0);
