...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Number of operations to compute element tensor = 157
    ...
    // Number of operations to compute tensor = 140
...
public:
  ...
  virtual const char* signature() const
  {
    return "(dXa0[0, 1]/dxb0[0, 1])(dXa1[0, 1]/dxb0[0, 1]) | ((d/dXa0[0, 1])vi0[0, 1, 2, 3, 4, 5])*((d/dXa1[0, 1])vi1[0, 1, 2, 3, 4, 5])*dX(0) +  | vi0[0, 1, 2, 3, 4, 5]*vi1[0, 1, 2, 3, 4, 5]*dX(0)";
  }
