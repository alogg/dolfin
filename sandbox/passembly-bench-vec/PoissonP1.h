...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    static const double FE0_C0_D01[4][2] = \
    {{-1, 1},
    {-1, 1},
    {-1, 1},
    {-1, 1}};
    ...
    for (unsigned int ip = 0; ip < 4; ip++)
    {
      ...
      for (unsigned int j = 0; j < 3; j++)
      {
        for (unsigned int k = 0; k < 3; k++)
        {
          ...
          A[nzc3[j]*6 + nzc3[k]] += FE0_C0[ip][j]*FE0_C0[ip][k]*Gip0;
          // Number of operations to compute entry: 3
      ...
      for (unsigned int j = 0; j < 2; j++)
      {
        ...
        {
          // Number of operations to compute entry: 3
          A[nzc5[j]*6 + nzc4[k]] += FE0_C0_D01[ip][j]*FE0_C0_D01[ip][k]*Gip1;
          // Number of operations to compute entry: 3
          A[nzc4[j]*6 + nzc4[k]] += FE0_C0_D01[ip][j]*FE0_C0_D01[ip][k]*Gip2;
          // Number of operations to compute entry: 3
          A[nzc1[j]*6 + nzc1[k]] += FE0_C0_D01[ip][j]*FE0_C0_D01[ip][k]*Gip2;
          // Number of operations to compute entry: 3
          A[nzc1[j]*6 + nzc2[k]] += FE0_C0_D01[ip][j]*FE0_C0_D01[ip][k]*Gip1;
          // Number of operations to compute entry: 3
          A[nzc2[j]*6 + nzc1[k]] += FE0_C0_D01[ip][j]*FE0_C0_D01[ip][k]*Gip1;
          // Number of operations to compute entry: 3
          A[nzc4[j]*6 + nzc5[k]] += FE0_C0_D01[ip][j]*FE0_C0_D01[ip][k]*Gip1;
          // Number of operations to compute entry: 3
          A[nzc2[j]*6 + nzc2[k]] += FE0_C0_D01[ip][j]*FE0_C0_D01[ip][k]*Gip3;
          // Number of operations to compute entry: 3
          A[nzc5[j]*6 + nzc5[k]] += FE0_C0_D01[ip][j]*FE0_C0_D01[ip][k]*Gip3;
        }// end loop over 'k'
      }// end loop over 'j'
    }// end loop over 'ip'
  }
...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(Sum(IndexSum(IndexSum(Product(Indexed(ComponentTensor(Indexed(SpatialDerivative(BasisFunction(VectorElement('Lagrange', Cell('triangle', 1, Space(2)), 1, 2), 0), MultiIndex((Index(0),), {Index(0): 2})), MultiIndex((Index(1),), {Index(1): 2})), MultiIndex((Index(1), Index(0)), {Index(0): 2, Index(1): 2})), MultiIndex((Index(2), Index(3)), {Index(2): 2, Index(3): 2})), Indexed(ComponentTensor(Indexed(SpatialDerivative(BasisFunction(VectorElement('Lagrange', Cell('triangle', 1, Space(2)), 1, 2), 1), MultiIndex((Index(4),), {Index(4): 2})), MultiIndex((Index(5),), {Index(5): 2})), MultiIndex((Index(5), Index(4)), {Index(4): 2, Index(5): 2})), MultiIndex((Index(2), Index(3)), {Index(2): 2, Index(3): 2}))), MultiIndex((Index(2),), {Index(2): 2})), MultiIndex((Index(3),), {Index(3): 2})), IndexSum(Product(Indexed(BasisFunction(VectorElement('Lagrange', Cell('triangle', 1, Space(2)), 1, 2), 0), MultiIndex((Index(6),), {Index(6): 2})), Indexed(BasisFunction(VectorElement('Lagrange', Cell('triangle', 1, Space(2)), 1, 2), 1), MultiIndex((Index(6),), {Index(6): 2}))), MultiIndex((Index(6),), {Index(6): 2}))), Measure('cell', 0, None))])";
  }
                               ...
                               const ufc::cell& c) const
  {
    ...
    for (unsigned int ip = 0; ip < 4; ip++)
    {
      ...
      for (unsigned int j = 0; j < 3; j++)
      {
        ...
        A[nzc1[j]] += FE0_C0[ip][j]*Gip0;
        // Number of operations to compute entry: 2
        A[nzc0[j]] += FE0_C0[ip][j]*Gip1;
      }// end loop over 'j'
    }// end loop over 'ip'
  }
