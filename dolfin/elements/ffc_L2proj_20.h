...
public:
  ...
  virtual const char* signature() const
  {
    return "MixedElement([FiniteElement('Discontinuous Lagrange', 'triangle', 1), FiniteElement('Discontinuous Lagrange', 'triangle', 1)])";
  }
...
public:
  ...
  virtual const char* signature() const
  {
    return "FFC dof map for MixedElement([FiniteElement('Discontinuous Lagrange', 'triangle', 1), FiniteElement('Discontinuous Lagrange', 'triangle', 1)])";
  }
...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Number of operations to compute element tensor = 36
...
class ffc_L2proj_20BilinearFormFunctionSpace0 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_20BilinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_20LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_20LinearForm_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
class ffc_L2proj_20BilinearFormFunctionSpace1 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_20BilinearFormFunctionSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_20LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_20LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_20LinearFormFunctionSpace0 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_20LinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_20LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_20LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_20LinearFormCoefficientSpace0 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_20LinearFormCoefficientSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_20LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_20LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_20TestSpace : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_20TestSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_20LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_20LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_20TrialSpace : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_20TrialSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_20LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_20LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_20CoefficientSpace : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_20CoefficientSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_20LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_20LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_20FunctionSpace : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_20FunctionSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_20LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_20LinearForm_dof_map_1()), mesh)))
  {
...
public:
  ...
  ffc_L2proj_20BilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form()
  {
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_ffc_L2proj_20BilinearForm());
  }

  // Create form on given function space(s) (shared data)
  ffc_L2proj_20BilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form()
  {
  ...
  // Destructor
  ~ffc_L2proj_20BilinearForm() {}

};

class ffc_L2proj_20LinearFormCoefficient0 : public dolfin::Coefficient
{
public:

  // Constructor
  ffc_L2proj_20LinearFormCoefficient0(dolfin::Form& form) : dolfin::Coefficient(form) {}

  // Destructor  
  ~ffc_L2proj_20LinearFormCoefficient0() {}

  // Attach function to coefficient
  const ffc_L2proj_20LinearFormCoefficient0& operator= (dolfin::Function& v)
  {
    attach(v);
    return *this;
  }
  ...
  {
    return new ffc_L2proj_20LinearFormCoefficientSpace0(form.mesh());
  }
...
public:
  ...
  // Create form on given function space(s)
  ffc_L2proj_20LinearForm(const dolfin::FunctionSpace& V0) : dolfin::Form(), w0(*this)
  {
    std::tr1::shared_ptr<const dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<const dolfin::FunctionSpace>());
    _function_spaces.push_back(_V0);
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_ffc_L2proj_20LinearForm());
  }

  // Create form on given function space(s) (shared data)
  ffc_L2proj_20LinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0) : dolfin::Form(), w0(*this)
  {
    _function_spaces.push_back(V0);
  ...
  ffc_L2proj_20LinearForm(const dolfin::FunctionSpace& V0, dolfin::Function& w0) : dolfin::Form(), w0(*this)
  {
    std::tr1::shared_ptr<const dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<const dolfin::FunctionSpace>());
    _function_spaces.push_back(_V0);
  ...
  ffc_L2proj_20LinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, dolfin::Function& w0) : dolfin::Form(), w0(*this)
  {
    _function_spaces.push_back(V0);
  ...
  // Destructor
  ~ffc_L2proj_20LinearForm() {}

  // Coefficients
  ffc_L2proj_20LinearFormCoefficient0 w0;
