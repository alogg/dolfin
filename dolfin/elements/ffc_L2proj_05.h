...
class ffc_L2proj_05BilinearFormFunctionSpace0 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_05BilinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_05LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_05LinearForm_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
class ffc_L2proj_05BilinearFormFunctionSpace1 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_05BilinearFormFunctionSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_05LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_05LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_05LinearFormFunctionSpace0 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_05LinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_05LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_05LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_05LinearFormCoefficientSpace0 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_05LinearFormCoefficientSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_05LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_05LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_05TestSpace : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_05TestSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_05LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_05LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_05TrialSpace : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_05TrialSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_05LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_05LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_05CoefficientSpace : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_05CoefficientSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_05LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_05LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_05FunctionSpace : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_05FunctionSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_05LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_05LinearForm_dof_map_1()), mesh)))
  {
...
public:
  ...
  ffc_L2proj_05BilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form()
  {
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_ffc_L2proj_05BilinearForm());
  }

  // Create form on given function space(s) (shared data)
  ffc_L2proj_05BilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form()
  {
  ...
  // Destructor
  ~ffc_L2proj_05BilinearForm() {}

};

class ffc_L2proj_05LinearFormCoefficient0 : public dolfin::Coefficient
{
public:

  // Constructor
  ffc_L2proj_05LinearFormCoefficient0(dolfin::Form& form) : dolfin::Coefficient(form) {}

  // Destructor  
  ~ffc_L2proj_05LinearFormCoefficient0() {}

  // Attach function to coefficient
  const ffc_L2proj_05LinearFormCoefficient0& operator= (dolfin::Function& v)
  {
    attach(v);
    return *this;
  }
  ...
  {
    return new ffc_L2proj_05LinearFormCoefficientSpace0(form.mesh());
  }
...
public:
  ...
  // Create form on given function space(s)
  ffc_L2proj_05LinearForm(const dolfin::FunctionSpace& V0) : dolfin::Form(), w0(*this)
  {
    std::tr1::shared_ptr<const dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<const dolfin::FunctionSpace>());
    _function_spaces.push_back(_V0);
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_ffc_L2proj_05LinearForm());
  }

  // Create form on given function space(s) (shared data)
  ffc_L2proj_05LinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0) : dolfin::Form(), w0(*this)
  {
    _function_spaces.push_back(V0);
  ...
  ffc_L2proj_05LinearForm(const dolfin::FunctionSpace& V0, dolfin::Function& w0) : dolfin::Form(), w0(*this)
  {
    std::tr1::shared_ptr<const dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<const dolfin::FunctionSpace>());
    _function_spaces.push_back(_V0);
  ...
  ffc_L2proj_05LinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, dolfin::Function& w0) : dolfin::Form(), w0(*this)
  {
    _function_spaces.push_back(V0);
  ...
  // Destructor
  ~ffc_L2proj_05LinearForm() {}

  // Coefficients
  ffc_L2proj_05LinearFormCoefficient0 w0;
