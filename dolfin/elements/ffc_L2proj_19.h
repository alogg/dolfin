...
class ffc_L2proj_19BilinearFormArgumentSpace0 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_19BilinearFormArgumentSpace0(const dolfin::Mesh& mesh)
...
class ffc_L2proj_19BilinearFormArgumentSpace1 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_19BilinearFormArgumentSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_19LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_19LinearForm_dof_map_1()), mesh)))
  {
...
class ffc_L2proj_19LinearFormArgumentSpace0 : public dolfin::FunctionSpace
{
public:

  ffc_L2proj_19LinearFormArgumentSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ffc_L2proj_19LinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ffc_L2proj_19LinearForm_dof_map_1()), mesh)))
  {
