...
class poisson1d_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  poisson1d_dof_map_0() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~poisson1d_dof_map_0()
  {
    // Do nothing
  }
                                    ...
                                    const ufc::cell& c) const
  {
    ...
    coordinates[0][0] = 1.000000000000000*x[0][0] + 0.000000000000000*x[1][0];
    coordinates[1][0] = 0.000000000000000*x[0][0] + 1.000000000000000*x[1][0];
  }
...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    A[0] = 1.000000000000000*G0_0_0;
    A[1] = (-1.000000000000000)*G0_0_0;
    A[2] = (-1.000000000000000)*G0_0_0;
    A[3] = 1.000000000000000*G0_0_0;
  }
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 0:
      {
        return new poisson1d_dof_map_0();
        break;
      }
    case 1:
      {
...
public:
  ...
  Form_0_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          ...
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson1d_dof_map_0()), mesh)))
  {
    // Do nothing
  }
