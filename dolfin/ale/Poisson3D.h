...
class poisson3d_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  poisson3d_dof_map_0() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~poisson3d_dof_map_0()
  {
    // Do nothing
  }
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 0:
      {
        return new poisson3d_dof_map_0();
        break;
      }
    case 1:
      {
...
public:
  ...
  Form_0_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          ...
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson3d_dof_map_0()), mesh)))
  {
    // Do nothing
  }
