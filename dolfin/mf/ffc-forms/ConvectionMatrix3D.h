...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(Product(BasisFunction(FiniteElement('Lagrange', Cell('tetrahedron', 1), 1), 0), Sum(Product(Constant(Cell('tetrahedron', 1), 2), SpatialDerivative(BasisFunction(FiniteElement('Lagrange', Cell('tetrahedron', 1), 1), 1), MultiIndex((FixedIndex(2),), {FixedIndex(2): 3}))), Sum(Product(Constant(Cell('tetrahedron', 1), 0), SpatialDerivative(BasisFunction(FiniteElement('Lagrange', Cell('tetrahedron', 1), 1), 1), MultiIndex((FixedIndex(0),), {FixedIndex(0): 3}))), Product(Constant(Cell('tetrahedron', 1), 1), SpatialDerivative(BasisFunction(FiniteElement('Lagrange', Cell('tetrahedron', 1), 1), 1), MultiIndex((FixedIndex(1),), {FixedIndex(1): 3})))))), Measure('cell', 0, None))])";
  }
