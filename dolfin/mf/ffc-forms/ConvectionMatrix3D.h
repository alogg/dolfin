...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Number of operations to compute element tensor = 50
    // Compute coefficients
    const double c0_0_0_0 = w[0][0];
    const double c1_1_0_0 = w[1][0];
    const double c2_2_0_0 = w[2][0];
    
    // Compute geometry tensors
    // Number of operations to compute decalrations = 18
    const double G0_0_0 = det*(c0_0_0_0*Jinv_00 + c1_1_0_0*Jinv_01 + c2_2_0_0*Jinv_02);
    const double G0_0_1 = det*(c0_0_0_0*Jinv_10 + c1_1_0_0*Jinv_11 + c2_2_0_0*Jinv_12);
    const double G0_0_2 = det*(c0_0_0_0*Jinv_20 + c1_1_0_0*Jinv_21 + c2_2_0_0*Jinv_22);
    
    // Compute element tensor
    // Number of operations to compute tensor = 32
    A[0] = -0.0416666666666666*G0_0_0 - 0.0416666666666666*G0_0_1 - 0.0416666666666666*G0_0_2;
    A[1] = 0.0416666666666666*G0_0_0;
    A[2] = 0.0416666666666666*G0_0_1;
    A[3] = 0.0416666666666666*G0_0_2;
    A[4] = -0.0416666666666666*G0_0_0 - 0.0416666666666666*G0_0_1 - 0.0416666666666666*G0_0_2;
    A[5] = 0.0416666666666666*G0_0_0;
    A[6] = 0.0416666666666666*G0_0_1;
    A[7] = 0.0416666666666666*G0_0_2;
    A[8] = -0.0416666666666666*G0_0_0 - 0.0416666666666666*G0_0_1 - 0.0416666666666666*G0_0_2;
    A[9] = 0.0416666666666666*G0_0_0;
    A[10] = 0.0416666666666666*G0_0_1;
    A[11] = 0.0416666666666666*G0_0_2;
    A[12] = -0.0416666666666666*G0_0_0 - 0.0416666666666666*G0_0_1 - 0.0416666666666666*G0_0_2;
    A[13] = 0.0416666666666666*G0_0_0;
    A[14] = 0.0416666666666666*G0_0_1;
    A[15] = 0.0416666666666666*G0_0_2;
  }
...
public:
  ...
  virtual const char* signature() const
  {
    return "w0_a0[0](dXa1[0, 1, 2]/dx0) | vi0[0, 1, 2, 3]*va0[0]*((d/dXa1[0, 1, 2])vi1[0, 1, 2, 3])*dX(0) + w1_a0[0](dXa1[0, 1, 2]/dx1) | vi0[0, 1, 2, 3]*va0[0]*((d/dXa1[0, 1, 2])vi1[0, 1, 2, 3])*dX(0) + w2_a0[0](dXa1[0, 1, 2]/dx2) | vi0[0, 1, 2, 3]*va0[0]*((d/dXa1[0, 1, 2])vi1[0, 1, 2, 3])*dX(0)";
  }
...
public:
  ...
  ConvectionMatrix3DBilinearFormCoefficientSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix3DBilinearForm_finite_element_2()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix3DBilinearForm_dof_map_2()), mesh)))
  {
    // Do nothing
  }
...
public:
  ...
  ConvectionMatrix3DBilinearFormCoefficientSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix3DBilinearForm_finite_element_3()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix3DBilinearForm_dof_map_3()), mesh)))
  {
    // Do nothing
  }
...
public:
  ...
  ConvectionMatrix3DBilinearFormCoefficientSpace2(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix3DBilinearForm_finite_element_4()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix3DBilinearForm_dof_map_4()), mesh)))
  {
    // Do nothing
  }
...
public:
  ...
  ConvectionMatrix3DBilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form(), cx(*this), cy(*this), cz(*this)
  {
  ...
  ConvectionMatrix3DBilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1, dolfin::Function& w0, dolfin::Function& w1, dolfin::Function& w2) : dolfin::Form(), cx(*this), cy(*this), cz(*this)
  {
    _function_spaces.push_back(V0);
    _function_spaces.push_back(V1);
