...
class UFC_MassMatrix2DBilinearForm_cell_integral_0_quadrature: public ufc::cell_integral
{
public:

  /// Constructor
  UFC_MassMatrix2DBilinearForm_cell_integral_0_quadrature() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_MassMatrix2DBilinearForm_cell_integral_0_quadrature()
  {
    // Do nothing
  }
...
private:
  ...
  UFC_MassMatrix2DBilinearForm_cell_integral_0_quadrature integral_0_quadrature;
...
class MassMatrix2DBilinearFormFunctionSpace0 : public dolfin::FunctionSpace
{
public:

  MassMatrix2DBilinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_MassMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_MassMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
class MassMatrix2DBilinearFormFunctionSpace1 : public dolfin::FunctionSpace
{
public:

  MassMatrix2DBilinearFormFunctionSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_MassMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_MassMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
...
class MassMatrix2DTestSpace : public dolfin::FunctionSpace
{
public:

  MassMatrix2DTestSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_MassMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_MassMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
...
class MassMatrix2DTrialSpace : public dolfin::FunctionSpace
{
public:

  MassMatrix2DTrialSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_MassMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_MassMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
...
class MassMatrix2DFunctionSpace : public dolfin::FunctionSpace
{
public:

  MassMatrix2DFunctionSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_MassMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_MassMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
...
public:
  ...
  MassMatrix2DBilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form()
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new UFC_MassMatrix2DBilinearForm());
  }

  // Create form on given function space(s) (shared data)
  MassMatrix2DBilinearForm(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form()
  {
