...
class UFC_MassMatrix3DBilinearForm_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  UFC_MassMatrix3DBilinearForm_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_MassMatrix3DBilinearForm_finite_element_0()
  {
    // Do nothing
  }
  ...
  {
    return new UFC_MassMatrix3DBilinearForm_finite_element_0();
  }
...
class UFC_MassMatrix3DBilinearForm_finite_element_1: public ufc::finite_element
{
public:

  /// Constructor
  UFC_MassMatrix3DBilinearForm_finite_element_1() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_MassMatrix3DBilinearForm_finite_element_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::finite_element* create_sub_element(unsigned int i) const
  {
    return new UFC_MassMatrix3DBilinearForm_finite_element_1();
  }
...
class UFC_MassMatrix3DBilinearForm_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  UFC_MassMatrix3DBilinearForm_dof_map_0() : ufc::dof_map()
  {
    __global_dimension = 0;
  }

  /// Destructor
  virtual ~UFC_MassMatrix3DBilinearForm_dof_map_0()
  {
    // Do nothing
  }
  ...
  {
    return new UFC_MassMatrix3DBilinearForm_dof_map_0();
  }
...
class UFC_MassMatrix3DBilinearForm_dof_map_1: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  UFC_MassMatrix3DBilinearForm_dof_map_1() : ufc::dof_map()
  {
    __global_dimension = 0;
  }

  /// Destructor
  virtual ~UFC_MassMatrix3DBilinearForm_dof_map_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::dof_map* create_sub_dof_map(unsigned int i) const
  {
    return new UFC_MassMatrix3DBilinearForm_dof_map_1();
  }
...
class UFC_MassMatrix3DBilinearForm_cell_integral_0_quadrature: public ufc::cell_integral
{
public:

  /// Constructor
  UFC_MassMatrix3DBilinearForm_cell_integral_0_quadrature() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_MassMatrix3DBilinearForm_cell_integral_0_quadrature()
  {
    // Do nothing
  }
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Total number of operations to compute element tensor: 392
    
    // Loop quadrature points for integral
    // Number of operations to compute element tensor for following IP loop = 392
    for (unsigned int ip = 0; ip < 8; ip++)
    {
      ...
      for (unsigned int j = 0; j < 4; j++)
      {
        for (unsigned int k = 0; k < 4; k++)
        {
          ...
          A[j*4 + k] += FE0[ip][j]*FE0[ip][k]*Gip0;
        }// end loop over 'k'
      }// end loop over 'j'
    }// end loop over 'ip'
  }
...
class UFC_MassMatrix3DBilinearForm_cell_integral_0: public ufc::cell_integral
{
private:

  UFC_MassMatrix3DBilinearForm_cell_integral_0_quadrature integral_0_quadrature;

public:

  /// Constructor
  UFC_MassMatrix3DBilinearForm_cell_integral_0() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_MassMatrix3DBilinearForm_cell_integral_0()
  {
    // Do nothing
  }
...
class UFC_MassMatrix3DBilinearForm: public ufc::form
{
public:

  /// Constructor
  UFC_MassMatrix3DBilinearForm() : ufc::form()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_MassMatrix3DBilinearForm()
  {
    // Do nothing
  }
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(Product(BasisFunction(FiniteElement('Lagrange', Cell('tetrahedron', 1), 1), 0), BasisFunction(FiniteElement('Lagrange', Cell('tetrahedron', 1), 1), 1)), Measure('cell', 0, None))])";
  }
  ...
  {
    return new UFC_MassMatrix3DBilinearForm_cell_integral_0();
  }
...
public:
  ...
  MassMatrix3DBilinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_MassMatrix3DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_MassMatrix3DBilinearForm_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
class MassMatrix3DTestSpace : public dolfin::FunctionSpace
{
public:

  MassMatrix3DTestSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_MassMatrix3DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_MassMatrix3DBilinearForm_dof_map_1()), mesh)))
  {
...
class MassMatrix3DTrialSpace : public dolfin::FunctionSpace
{
public:

  MassMatrix3DTrialSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_MassMatrix3DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_MassMatrix3DBilinearForm_dof_map_1()), mesh)))
  {
...
class MassMatrix3DFunctionSpace : public dolfin::FunctionSpace
{
public:

  MassMatrix3DFunctionSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_MassMatrix3DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_MassMatrix3DBilinearForm_dof_map_1()), mesh)))
  {
...
class MassMatrix3DBilinearForm : public dolfin::Form
{
public:

  // Create form on given function space(s)
  MassMatrix3DBilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form()
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new UFC_MassMatrix3DBilinearForm());
  }

  // Create form on given function space(s) (shared data)
  MassMatrix3DBilinearForm(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form()
  {
