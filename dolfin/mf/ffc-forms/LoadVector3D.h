...
public:
  ...
  LoadVector3DLinearForm(const dolfin::FunctionSpace& V0) : dolfin::Form(), c(*this)
  {
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_LoadVector3DLinearForm());
  }

  // Create form on given function space(s) (shared data)
  LoadVector3DLinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0) : dolfin::Form(), c(*this)
  {
  ...
  LoadVector3DLinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, dolfin::Function& w0) : dolfin::Form(), c(*this)
  {
    _function_spaces.push_back(V0);
