...
public:
  ...
  StiffnessMatrix3DBilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form(), c(*this)
  {
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_StiffnessMatrix3DBilinearForm());
  }

  // Create form on given function space(s) (shared data)
  StiffnessMatrix3DBilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form(), c(*this)
  {
  ...
  StiffnessMatrix3DBilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1, dolfin::Function& w0) : dolfin::Form(), c(*this)
  {
    _function_spaces.push_back(V0);
    _function_spaces.push_back(V1);
