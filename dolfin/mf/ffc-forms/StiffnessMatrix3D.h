...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    // Number of operations to compute element tensor = 119
    // Compute coefficients
    const double c0_0_0_0 = w[0][0];
    
    // Compute geometry tensors
    // Number of operations to compute decalrations = 63
    ...
    const double G0_0_1_0 = det*c0_0_0_0*(Jinv_10*Jinv_00 + Jinv_11*Jinv_01 + Jinv_12*Jinv_02);
    const double G0_0_1_1 = det*c0_0_0_0*(Jinv_10*Jinv_10 + Jinv_11*Jinv_11 + Jinv_12*Jinv_12);
    const double G0_0_1_2 = det*c0_0_0_0*(Jinv_10*Jinv_20 + Jinv_11*Jinv_21 + Jinv_12*Jinv_22);
    const double G0_0_2_0 = det*c0_0_0_0*(Jinv_20*Jinv_00 + Jinv_21*Jinv_01 + Jinv_22*Jinv_02);
    const double G0_0_2_1 = det*c0_0_0_0*(Jinv_20*Jinv_10 + Jinv_21*Jinv_11 + Jinv_22*Jinv_12);
    const double G0_0_2_2 = det*c0_0_0_0*(Jinv_20*Jinv_20 + Jinv_21*Jinv_21 + Jinv_22*Jinv_22);
    
    // Compute element tensor
    // Number of operations to compute tensor = 56
    A[0] = 0.166666666666666*G0_0_0_0 + 0.166666666666666*G0_0_0_1 + 0.166666666666666*G0_0_0_2 + 0.166666666666666*G0_0_1_0 + 0.166666666666666*G0_0_1_1 + 0.166666666666666*G0_0_1_2 + 0.166666666666666*G0_0_2_0 + 0.166666666666666*G0_0_2_1 + 0.166666666666666*G0_0_2_2;
    A[1] = -0.166666666666666*G0_0_0_0 - 0.166666666666666*G0_0_1_0 - 0.166666666666666*G0_0_2_0;
    A[2] = -0.166666666666666*G0_0_0_1 - 0.166666666666666*G0_0_1_1 - 0.166666666666666*G0_0_2_1;
    A[3] = -0.166666666666666*G0_0_0_2 - 0.166666666666666*G0_0_1_2 - 0.166666666666666*G0_0_2_2;
    A[4] = -0.166666666666666*G0_0_0_0 - 0.166666666666666*G0_0_0_1 - 0.166666666666666*G0_0_0_2;
    A[5] = 0.166666666666666*G0_0_0_0;
    A[6] = 0.166666666666666*G0_0_0_1;
    A[7] = 0.166666666666666*G0_0_0_2;
    A[8] = -0.166666666666666*G0_0_1_0 - 0.166666666666666*G0_0_1_1 - 0.166666666666666*G0_0_1_2;
    A[9] = 0.166666666666666*G0_0_1_0;
    A[10] = 0.166666666666666*G0_0_1_1;
    A[11] = 0.166666666666666*G0_0_1_2;
    A[12] = -0.166666666666666*G0_0_2_0 - 0.166666666666666*G0_0_2_1 - 0.166666666666666*G0_0_2_2;
    A[13] = 0.166666666666666*G0_0_2_0;
    A[14] = 0.166666666666666*G0_0_2_1;
    A[15] = 0.166666666666666*G0_0_2_2;
  }
...
public:
  ...
  virtual const char* signature() const
  {
    return "w0_a0[0](dXa1[0, 1, 2]/dxb0[0, 1, 2])(dXa2[0, 1, 2]/dxb0[0, 1, 2]) | va0[0]*((d/dXa1[0, 1, 2])vi0[0, 1, 2, 3])*((d/dXa2[0, 1, 2])vi1[0, 1, 2, 3])*dX(0)";
  }
...
class StiffnessMatrix3DBilinearFormArgumentSpace0 : public dolfin::FunctionSpace
{
public:

  StiffnessMatrix3DBilinearFormArgumentSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_StiffnessMatrix3DBilinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_StiffnessMatrix3DBilinearForm_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
class StiffnessMatrix3DBilinearFormArgumentSpace1 : public dolfin::FunctionSpace
{
public:

  StiffnessMatrix3DBilinearFormArgumentSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_StiffnessMatrix3DBilinearForm_finite_element_1()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_StiffnessMatrix3DBilinearForm_dof_map_1()), mesh)))
  {
...
public:
  ...
  StiffnessMatrix3DBilinearFormCoefficientSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(std::tr1::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            std::tr1::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(std::tr1::shared_ptr<ufc::finite_element>(new UFC_StiffnessMatrix3DBilinearForm_finite_element_2()))),
                            std::tr1::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(std::tr1::shared_ptr<ufc::dof_map>(new UFC_StiffnessMatrix3DBilinearForm_dof_map_2()), mesh)))
  {
    // Do nothing
  }
...
public:
  ...
  // Constructor
  StiffnessMatrix3DBilinearForm(dolfin::FunctionSpace& V0, dolfin::FunctionSpace& V1) : dolfin::Form(), c(*this)
  {
    ...
    _ufc_form = new UFC_StiffnessMatrix3DBilinearForm();


  }

  // Constructor
  StiffnessMatrix3DBilinearForm(std::tr1::shared_ptr<dolfin::FunctionSpace> V0, std::tr1::shared_ptr<dolfin::FunctionSpace> V1) : dolfin::Form(), c(*this)
  {
