...
public:
  ...
  StiffnessMatrix2DBilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form(), c(*this)
  {
  ...
  StiffnessMatrix2DBilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1, dolfin::Function& w0) : dolfin::Form(), c(*this)
  {
    _function_spaces.push_back(V0);
    _function_spaces.push_back(V1);
