...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    const double G0 = W1*det*(Jinv_00*w[0][0] + Jinv_01*w[1][0]);
    const double G1 = W1*det*(Jinv_10*w[0][0] + Jinv_11*w[1][0]);
    ...
    for (unsigned int j = 0; j < 3; j++)
    {
      for (unsigned int k = 0; k < 2; k++)
      {
        ...
        A[j*3 + nzc1[k]] += FE0[0][j]*FE0_D01[0][k]*G0;
        // Number of operations to compute entry: 3
        A[j*3 + nzc0[k]] += FE0[0][j]*FE0_D01[0][k]*G1;
      }// end loop over 'k'
    }// end loop over 'j'
  }
