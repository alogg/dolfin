...
class UFC_ConvectionMatrix2DBilinearForm_cell_integral_0_quadrature: public ufc::cell_integral
{
public:

  /// Constructor
  UFC_ConvectionMatrix2DBilinearForm_cell_integral_0_quadrature() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_ConvectionMatrix2DBilinearForm_cell_integral_0_quadrature()
  {
    // Do nothing
  }
...
private:
  ...
  UFC_ConvectionMatrix2DBilinearForm_cell_integral_0_quadrature integral_0_quadrature;
...
class ConvectionMatrix2DBilinearFormFunctionSpace0 : public dolfin::FunctionSpace
{
public:

  ConvectionMatrix2DBilinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
class ConvectionMatrix2DBilinearFormFunctionSpace1 : public dolfin::FunctionSpace
{
public:

  ConvectionMatrix2DBilinearFormFunctionSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
...
class ConvectionMatrix2DBilinearFormCoefficientSpace0 : public dolfin::FunctionSpace
{
public:

  ConvectionMatrix2DBilinearFormCoefficientSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix2DBilinearForm_finite_element_3()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix2DBilinearForm_dof_map_3()), mesh)))
  {
    // Do nothing
  }
...
class ConvectionMatrix2DBilinearFormCoefficientSpace1 : public dolfin::FunctionSpace
{
public:

  ConvectionMatrix2DBilinearFormCoefficientSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix2DBilinearForm_finite_element_3()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix2DBilinearForm_dof_map_3()), mesh)))
  {
...
class ConvectionMatrix2DTestSpace : public dolfin::FunctionSpace
{
public:

  ConvectionMatrix2DTestSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
...
class ConvectionMatrix2DTrialSpace : public dolfin::FunctionSpace
{
public:

  ConvectionMatrix2DTrialSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
...
class ConvectionMatrix2DCoefficientSpace : public dolfin::FunctionSpace
{
public:

  ConvectionMatrix2DCoefficientSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix2DBilinearForm_finite_element_3()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix2DBilinearForm_dof_map_3()), mesh)))
  {
...
class ConvectionMatrix2DFunctionSpace : public dolfin::FunctionSpace
{
public:

  ConvectionMatrix2DFunctionSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_ConvectionMatrix2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_ConvectionMatrix2DBilinearForm_dof_map_1()), mesh)))
  {
...
class ConvectionMatrix2DBilinearFormCoefficient0 : public dolfin::Coefficient
{
public:

  // Constructor
  ConvectionMatrix2DBilinearFormCoefficient0(dolfin::Form& form) : dolfin::Coefficient(form) {}

  // Destructor  
  ~ConvectionMatrix2DBilinearFormCoefficient0() {}

  // Attach function to coefficient
  const ConvectionMatrix2DBilinearFormCoefficient0& operator= (dolfin::Function& v)
  {
    attach(v);
    return *this;
  }
  ...
  {
    return new ConvectionMatrix2DBilinearFormCoefficientSpace0(form.mesh());
  }
...
public:
  ...
  // Constructor
  ConvectionMatrix2DBilinearFormCoefficient1(dolfin::Form& form) : dolfin::Coefficient(form) {}

  // Destructor  
  ~ConvectionMatrix2DBilinearFormCoefficient1() {}

  // Attach function to coefficient
  const ConvectionMatrix2DBilinearFormCoefficient1& operator= (dolfin::Function& v)
  {
    attach(v);
    return *this;
  }
  ...
  const dolfin::FunctionSpace* create_function_space() const
  {
    return new ConvectionMatrix2DBilinearFormCoefficientSpace1(form.mesh());
  }
...
public:
  ...
  ConvectionMatrix2DBilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form(), cx(*this), cy(*this)
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new UFC_ConvectionMatrix2DBilinearForm());
  }

  // Create form on given function space(s) (shared data)
  ConvectionMatrix2DBilinearForm(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form(), cx(*this), cy(*this)
  {
  ...
  ConvectionMatrix2DBilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1, dolfin::Function& w0, dolfin::Function& w1) : dolfin::Form(), cx(*this), cy(*this)
  {
    boost::shared_ptr<const dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<const dolfin::FunctionSpace>());
    _function_spaces.push_back(_V0);
    boost::shared_ptr<const dolfin::FunctionSpace> _V1(&V1, dolfin::NoDeleter<const dolfin::FunctionSpace>());
  ...
  ConvectionMatrix2DBilinearForm(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::FunctionSpace> V1, dolfin::Function& w0, dolfin::Function& w1) : dolfin::Form(), cx(*this), cy(*this)
  {
    _function_spaces.push_back(V0);
    _function_spaces.push_back(V1);
  ...
  // Destructor
  ~ConvectionMatrix2DBilinearForm() {}

  // Coefficients
  ConvectionMatrix2DBilinearFormCoefficient0 cx;
  ConvectionMatrix2DBilinearFormCoefficient1 cy;
