...
// Documentation extracted from: (module=function, header=Data.h)
...
* set\ **(dolfin_cell, ufc_cell, local_facet)**
...
* set_coefficients\ **(std::map<std::string, coefficients)**
