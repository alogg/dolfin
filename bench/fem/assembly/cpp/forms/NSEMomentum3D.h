...
public:
                               ...
                               const ufc::cell& c) const
  {
    ...
    static const double FE1_C0[8][3] = \
    ...
    static const double FE1_C1[8][3] = \
    ...
    static const double FE1_C2[8][3] = \
    ...
    static const double FE2_C0[8][12] = \
    ...
    static const double FE2_C0_D001[8][12] = \
    ...
    static const double FE2_C0_D010[8][12] = \
    ...
    static const double FE2_C0_D100[8][12] = \
    ...
    static const double FE2_C1[8][12] = \
    ...
    static const double FE2_C1_D001[8][12] = \
    ...
    static const double FE2_C1_D010[8][12] = \
    ...
    static const double FE2_C1_D100[8][12] = \
    ...
    static const double FE2_C2[8][12] = \
    ...
    static const double FE2_C2_D001[8][12] = \
    ...
    static const double FE2_C2_D010[8][12] = \
    ...
    static const double FE2_C2_D100[8][12] = \
    ...
    // Number of operations to compute element tensor for following IP loop = 409168
    for (unsigned int ip = 0; ip < 8; ip++)
    {
      ...
      for (unsigned int r = 0; r < 3; r++)
      {
        ...
        F4 += FE1_C2[ip][r]*w[0][r];
      }// end loop over 'r'
      
      // Number of operations for primary indices: 51120
      for (unsigned int j = 0; j < 12; j++)
      {
        for (unsigned int k = 0; k < 12; k++)
        {
          // Number of operations to compute entry: 355
          A[j*12 + k] += ((((((((K_00*FE2_C2_D100[ip][j] + K_10*FE2_C2_D010[ip][j] + K_20*FE2_C2_D001[ip][j]))*F4 + ((K_00*FE2_C1_D100[ip][j] + K_10*FE2_C1_D010[ip][j] + K_20*FE2_C1_D001[ip][j]))*F3 + ((K_00*FE2_C0_D100[ip][j] + K_10*FE2_C0_D010[ip][j] + K_20*FE2_C0_D001[ip][j]))*F2))*((((K_00*FE2_C0_D100[ip][k] + K_10*FE2_C0_D010[ip][k] + K_20*FE2_C0_D001[ip][k]))*F2 + ((K_00*FE2_C1_D100[ip][k] + K_10*FE2_C1_D010[ip][k] + K_20*FE2_C1_D001[ip][k]))*F3 + ((K_00*FE2_C2_D100[ip][k] + K_10*FE2_C2_D010[ip][k] + K_20*FE2_C2_D001[ip][k]))*F4)) + ((((K_01*FE2_C1_D100[ip][j] + K_11*FE2_C1_D010[ip][j] + K_21*FE2_C1_D001[ip][j]))*F3 + ((K_01*FE2_C2_D100[ip][j] + K_11*FE2_C2_D010[ip][j] + K_21*FE2_C2_D001[ip][j]))*F4 + ((K_01*FE2_C0_D100[ip][j] + K_11*FE2_C0_D010[ip][j] + K_21*FE2_C0_D001[ip][j]))*F2))*((((K_01*FE2_C1_D100[ip][k] + K_11*FE2_C1_D010[ip][k] + K_21*FE2_C1_D001[ip][k]))*F3 + ((K_01*FE2_C2_D100[ip][k] + K_11*FE2_C2_D010[ip][k] + K_21*FE2_C2_D001[ip][k]))*F4 + ((K_01*FE2_C0_D100[ip][k] + K_11*FE2_C0_D010[ip][k] + K_21*FE2_C0_D001[ip][k]))*F2)) + ((((K_02*FE2_C0_D100[ip][j] + K_12*FE2_C0_D010[ip][j] + K_22*FE2_C0_D001[ip][j]))*F2 + ((K_02*FE2_C1_D100[ip][j] + K_12*FE2_C1_D010[ip][j] + K_22*FE2_C1_D001[ip][j]))*F3 + ((K_02*FE2_C2_D100[ip][j] + K_12*FE2_C2_D010[ip][j] + K_22*FE2_C2_D001[ip][j]))*F4))*((((K_02*FE2_C0_D100[ip][k] + K_12*FE2_C0_D010[ip][k] + K_22*FE2_C0_D001[ip][k]))*F2 + ((K_02*FE2_C2_D100[ip][k] + K_12*FE2_C2_D010[ip][k] + K_22*FE2_C2_D001[ip][k]))*F4 + ((K_02*FE2_C1_D100[ip][k] + K_12*FE2_C1_D010[ip][k] + K_22*FE2_C1_D001[ip][k]))*F3))))*F0*0.500000000000000*F5 + (((K_00*FE2_C0_D100[ip][k] + K_10*FE2_C0_D010[ip][k] + K_20*FE2_C0_D001[ip][k]) + (K_02*FE2_C2_D100[ip][k] + K_12*FE2_C2_D010[ip][k] + K_22*FE2_C2_D001[ip][k]) + (K_01*FE2_C1_D100[ip][k] + K_11*FE2_C1_D010[ip][k] + K_21*FE2_C1_D001[ip][k])))*((((K_00*FE2_C0_D100[ip][j] + K_10*FE2_C0_D010[ip][j] + K_20*FE2_C0_D001[ip][j]) + (K_01*FE2_C1_D100[ip][j] + K_11*FE2_C1_D010[ip][j] + K_21*FE2_C1_D001[ip][j]) + (K_02*FE2_C2_D100[ip][j] + K_12*FE2_C2_D010[ip][j] + K_22*FE2_C2_D001[ip][j])))*F0*0.500000000000000*F1)) + (((((((K_01*FE2_C0_D100[ip][j] + K_11*FE2_C0_D010[ip][j] + K_21*FE2_C0_D001[ip][j]))*((K_01*FE2_C0_D100[ip][k] + K_11*FE2_C0_D010[ip][k] + K_21*FE2_C0_D001[ip][k])) + ((K_01*FE2_C2_D100[ip][j] + K_11*FE2_C2_D010[ip][j] + K_21*FE2_C2_D001[ip][j]))*((K_01*FE2_C2_D100[ip][k] + K_11*FE2_C2_D010[ip][k] + K_21*FE2_C2_D001[ip][k])) + ((K_01*FE2_C1_D100[ip][j] + K_11*FE2_C1_D010[ip][j] + K_21*FE2_C1_D001[ip][j]))*((K_01*FE2_C1_D100[ip][k] + K_11*FE2_C1_D010[ip][k] + K_21*FE2_C1_D001[ip][k]))) + (((K_02*FE2_C0_D100[ip][j] + K_12*FE2_C0_D010[ip][j] + K_22*FE2_C0_D001[ip][j]))*((K_02*FE2_C0_D100[ip][k] + K_12*FE2_C0_D010[ip][k] + K_22*FE2_C0_D001[ip][k])) + ((K_02*FE2_C2_D100[ip][j] + K_12*FE2_C2_D010[ip][j] + K_22*FE2_C2_D001[ip][j]))*((K_02*FE2_C2_D100[ip][k] + K_12*FE2_C2_D010[ip][k] + K_22*FE2_C2_D001[ip][k])) + ((K_02*FE2_C1_D100[ip][j] + K_12*FE2_C1_D010[ip][j] + K_22*FE2_C1_D001[ip][j]))*((K_02*FE2_C1_D100[ip][k] + K_12*FE2_C1_D010[ip][k] + K_22*FE2_C1_D001[ip][k]))) + (((K_00*FE2_C2_D100[ip][j] + K_10*FE2_C2_D010[ip][j] + K_20*FE2_C2_D001[ip][j]))*((K_00*FE2_C2_D100[ip][k] + K_10*FE2_C2_D010[ip][k] + K_20*FE2_C2_D001[ip][k])) + ((K_00*FE2_C1_D100[ip][j] + K_10*FE2_C1_D010[ip][j] + K_20*FE2_C1_D001[ip][j]))*((K_00*FE2_C1_D100[ip][k] + K_10*FE2_C1_D010[ip][k] + K_20*FE2_C1_D001[ip][k])) + ((K_00*FE2_C0_D100[ip][j] + K_10*FE2_C0_D010[ip][j] + K_20*FE2_C0_D001[ip][j]))*((K_00*FE2_C0_D100[ip][k] + K_10*FE2_C0_D010[ip][k] + K_20*FE2_C0_D001[ip][k])))))*F6*0.500000000000000*F0 + (FE2_C1[ip][j]*FE2_C1[ip][k] + FE2_C2[ip][j]*FE2_C2[ip][k] + FE2_C0[ip][j]*FE2_C0[ip][k])) + ((FE2_C0[ip][j]*((((K_00*FE2_C0_D100[ip][k] + K_10*FE2_C0_D010[ip][k] + K_20*FE2_C0_D001[ip][k]))*F2 + ((K_00*FE2_C1_D100[ip][k] + K_10*FE2_C1_D010[ip][k] + K_20*FE2_C1_D001[ip][k]))*F3 + ((K_00*FE2_C2_D100[ip][k] + K_10*FE2_C2_D010[ip][k] + K_20*FE2_C2_D001[ip][k]))*F4)) + FE2_C2[ip][j]*((((K_02*FE2_C0_D100[ip][k] + K_12*FE2_C0_D010[ip][k] + K_22*FE2_C0_D001[ip][k]))*F2 + ((K_02*FE2_C2_D100[ip][k] + K_12*FE2_C2_D010[ip][k] + K_22*FE2_C2_D001[ip][k]))*F4 + ((K_02*FE2_C1_D100[ip][k] + K_12*FE2_C1_D010[ip][k] + K_22*FE2_C1_D001[ip][k]))*F3)) + FE2_C1[ip][j]*((((K_01*FE2_C1_D100[ip][k] + K_11*FE2_C1_D010[ip][k] + K_21*FE2_C1_D001[ip][k]))*F3 + ((K_01*FE2_C2_D100[ip][k] + K_11*FE2_C2_D010[ip][k] + K_21*FE2_C2_D001[ip][k]))*F4 + ((K_01*FE2_C0_D100[ip][k] + K_11*FE2_C0_D010[ip][k] + K_21*FE2_C0_D001[ip][k]))*F2))))*0.500000000000000*F0))*W8[ip]*det;
        }// end loop over 'k'
      }// end loop over 'j'
    }// end loop over 'ip'
  }
