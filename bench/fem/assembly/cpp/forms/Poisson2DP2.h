...
class poisson2dp2_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  poisson2dp2_dof_map_0() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~poisson2dp2_dof_map_0()
  {
    // Do nothing
  }
...
class poisson2dp2_cell_integral_0_0: public ufc::cell_integral
{
public:

  /// Constructor
  poisson2dp2_cell_integral_0_0() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson2dp2_cell_integral_0_0()
  {
    // Do nothing
  }
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 0:
      {
        return new poisson2dp2_dof_map_0();
        break;
      }
    case 1:
      {
  ...
  virtual ufc::cell_integral* create_cell_integral(unsigned int i) const
  {
    ...
    case 0:
      {
        return new poisson2dp2_cell_integral_0_0();
        break;
      }
    }
...
public:
  ...
  Form_0_FunctionSpace_0(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new poisson2dp2_finite_element_0()))),
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson2dp2_dof_map_0()), mesh)))
  {
    // Do nothing
  }
