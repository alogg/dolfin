...
public:
  ...
  StabStokes2DBilinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_StabStokes2DBilinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_StabStokes2DBilinearForm_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
public:
  ...
  StabStokes2DBilinearFormCoefficientSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_StabStokes2DBilinearForm_finite_element_2()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_StabStokes2DBilinearForm_dof_map_2()), mesh)))
  {
    // Do nothing
  }
...
public:
  ...
  StabStokes2DBilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form(), h(*this)
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new UFC_StabStokes2DBilinearForm());
  }

  // Create form on given function space(s) (shared data)
  StabStokes2DBilinearForm(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form(), h(*this)
  {
  ...
  StabStokes2DBilinearForm(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::FunctionSpace> V1, dolfin::Function& w0) : dolfin::Form(), h(*this)
  {
    _function_spaces.push_back(V0);
    _function_spaces.push_back(V1);
