...
class poisson2d_1_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  poisson2d_1_dof_map_0() : ufc::dof_map()
  {
    _global_dimension = 0;
  }

  /// Destructor
  virtual ~poisson2d_1_dof_map_0()
  {
    // Do nothing
  }
...
public:
  ...
  virtual ufc::dof_map* create_dof_map(unsigned int i) const
  {
    ...
    case 0:
      {
        return new poisson2d_1_dof_map_0();
        break;
      }
    case 1:
      {
...
public:
  ...
  CoefficientSpace_f(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          ...
                          boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson2d_1_dof_map_0()), mesh)))
  {
    // Do nothing
  }
