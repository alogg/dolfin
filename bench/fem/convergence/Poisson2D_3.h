...
public:
  ...
  Poisson2D_3BilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form()
  {
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_Poisson2D_3BilinearForm());
  }

  // Create form on given function space(s) (shared data)
  Poisson2D_3BilinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, std::tr1::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form()
  {
...
public:
  ...
  Poisson2D_3LinearForm(const dolfin::FunctionSpace& V0) : dolfin::Form(), f(*this)
  {
    ...
    _ufc_form = std::tr1::shared_ptr<const ufc::form>(new UFC_Poisson2D_3LinearForm());
  }

  // Create form on given function space(s) (shared data)
  Poisson2D_3LinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0) : dolfin::Form(), f(*this)
  {
    _function_spaces.push_back(V0);
  ...
  Poisson2D_3LinearForm(std::tr1::shared_ptr<const dolfin::FunctionSpace> V0, dolfin::Function& w0) : dolfin::Form(), f(*this)
  {
    _function_spaces.push_back(V0);
