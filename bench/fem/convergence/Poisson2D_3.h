...
public:
                                    ...
                                    const ufc::cell& c) const
  {
    ...
    coordinates[3][0] = (-0.000000000000000)*x[0][0] + 0.666666666666667*x[1][0] + 0.333333333333333*x[2][0];
    coordinates[3][1] = (-0.000000000000000)*x[0][1] + 0.666666666666667*x[1][1] + 0.333333333333333*x[2][1];
    coordinates[4][0] = 0.000000000000000*x[0][0] + 0.333333333333333*x[1][0] + 0.666666666666667*x[2][0];
    coordinates[4][1] = 0.000000000000000*x[0][1] + 0.333333333333333*x[1][1] + 0.666666666666667*x[2][1];
    coordinates[5][0] = 0.666666666666667*x[0][0] + 0.000000000000000*x[1][0] + 0.333333333333333*x[2][0];
    coordinates[5][1] = 0.666666666666667*x[0][1] + 0.000000000000000*x[1][1] + 0.333333333333333*x[2][1];
    coordinates[6][0] = 0.333333333333333*x[0][0] + 0.000000000000000*x[1][0] + 0.666666666666667*x[2][0];
    coordinates[6][1] = 0.333333333333333*x[0][1] + 0.000000000000000*x[1][1] + 0.666666666666667*x[2][1];
    coordinates[7][0] = 0.666666666666667*x[0][0] + 0.333333333333333*x[1][0] + 0.000000000000000*x[2][0];
    coordinates[7][1] = 0.666666666666667*x[0][1] + 0.333333333333333*x[1][1] + 0.000000000000000*x[2][1];
    coordinates[8][0] = 0.333333333333333*x[0][0] + 0.666666666666667*x[1][0] + 0.000000000000000*x[2][0];
    coordinates[8][1] = 0.333333333333333*x[0][1] + 0.666666666666667*x[1][1] + 0.000000000000000*x[2][1];
