...
class UFC_Poisson3D_1BilinearForm_cell_integral_0_quadrature: public ufc::cell_integral
{
public:

  /// Constructor
  UFC_Poisson3D_1BilinearForm_cell_integral_0_quadrature() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_Poisson3D_1BilinearForm_cell_integral_0_quadrature()
  {
    // Do nothing
  }
...
private:
  ...
  UFC_Poisson3D_1BilinearForm_cell_integral_0_quadrature integral_0_quadrature;
...
class UFC_Poisson3D_1LinearForm_cell_integral_0_quadrature: public ufc::cell_integral
{
public:

  /// Constructor
  UFC_Poisson3D_1LinearForm_cell_integral_0_quadrature() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~UFC_Poisson3D_1LinearForm_cell_integral_0_quadrature()
  {
    // Do nothing
  }
...
private:
  ...
  UFC_Poisson3D_1LinearForm_cell_integral_0_quadrature integral_0_quadrature;
...
class Poisson3D_1BilinearFormFunctionSpace0 : public dolfin::FunctionSpace
{
public:

  Poisson3D_1BilinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_Poisson3D_1LinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_Poisson3D_1LinearForm_dof_map_1()), mesh)))
  {
    // Do nothing
  }
...
class Poisson3D_1BilinearFormFunctionSpace1 : public dolfin::FunctionSpace
{
public:

  Poisson3D_1BilinearFormFunctionSpace1(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_Poisson3D_1LinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_Poisson3D_1LinearForm_dof_map_1()), mesh)))
  {
...
class Poisson3D_1LinearFormFunctionSpace0 : public dolfin::FunctionSpace
{
public:

  Poisson3D_1LinearFormFunctionSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_Poisson3D_1LinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_Poisson3D_1LinearForm_dof_map_1()), mesh)))
  {
...
class Poisson3D_1LinearFormCoefficientSpace0 : public dolfin::FunctionSpace
{
public:

  Poisson3D_1LinearFormCoefficientSpace0(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_Poisson3D_1LinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_Poisson3D_1LinearForm_dof_map_1()), mesh)))
  {
...
class Poisson3D_1TestSpace : public dolfin::FunctionSpace
{
public:

  Poisson3D_1TestSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_Poisson3D_1LinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_Poisson3D_1LinearForm_dof_map_1()), mesh)))
  {
...
class Poisson3D_1TrialSpace : public dolfin::FunctionSpace
{
public:

  Poisson3D_1TrialSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_Poisson3D_1LinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_Poisson3D_1LinearForm_dof_map_1()), mesh)))
  {
...
class Poisson3D_1CoefficientSpace : public dolfin::FunctionSpace
{
public:

  Poisson3D_1CoefficientSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_Poisson3D_1LinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_Poisson3D_1LinearForm_dof_map_1()), mesh)))
  {
...
class Poisson3D_1FunctionSpace : public dolfin::FunctionSpace
{
public:

  Poisson3D_1FunctionSpace(const dolfin::Mesh& mesh)
    : dolfin::FunctionSpace(boost::shared_ptr<const dolfin::Mesh>(&mesh, dolfin::NoDeleter<const dolfin::Mesh>()),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new UFC_Poisson3D_1LinearForm_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new UFC_Poisson3D_1LinearForm_dof_map_1()), mesh)))
  {
...
public:
  ...
  Poisson3D_1BilinearForm(const dolfin::FunctionSpace& V0, const dolfin::FunctionSpace& V1) : dolfin::Form()
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new UFC_Poisson3D_1BilinearForm());
  }

  // Create form on given function space(s) (shared data)
  Poisson3D_1BilinearForm(boost::shared_ptr<const dolfin::FunctionSpace> V0, boost::shared_ptr<const dolfin::FunctionSpace> V1) : dolfin::Form()
  {
  ...
  // Destructor
  ~Poisson3D_1BilinearForm() {}

};

class Poisson3D_1LinearFormCoefficient0 : public dolfin::Coefficient
{
public:

  // Constructor
  Poisson3D_1LinearFormCoefficient0(dolfin::Form& form) : dolfin::Coefficient(form) {}

  // Destructor  
  ~Poisson3D_1LinearFormCoefficient0() {}

  // Attach function to coefficient
  const Poisson3D_1LinearFormCoefficient0& operator= (dolfin::Function& v)
  {
    attach(v);
    return *this;
  }
  ...
  {
    return new Poisson3D_1LinearFormCoefficientSpace0(form.mesh());
  }
...
public:
  ...
  // Create form on given function space(s)
  Poisson3D_1LinearForm(const dolfin::FunctionSpace& V0) : dolfin::Form(), f(*this)
  {
    boost::shared_ptr<const dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<const dolfin::FunctionSpace>());
    _function_spaces.push_back(_V0);
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new UFC_Poisson3D_1LinearForm());
  }

  // Create form on given function space(s) (shared data)
  Poisson3D_1LinearForm(boost::shared_ptr<const dolfin::FunctionSpace> V0) : dolfin::Form(), f(*this)
  {
    _function_spaces.push_back(V0);
  ...
  Poisson3D_1LinearForm(const dolfin::FunctionSpace& V0, dolfin::Function& w0) : dolfin::Form(), f(*this)
  {
    boost::shared_ptr<const dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<const dolfin::FunctionSpace>());
    _function_spaces.push_back(_V0);
  ...
  Poisson3D_1LinearForm(boost::shared_ptr<const dolfin::FunctionSpace> V0, dolfin::Function& w0) : dolfin::Form(), f(*this)
  {
    _function_spaces.push_back(V0);
  ...
  // Destructor
  ~Poisson3D_1LinearForm() {}

  // Coefficients
  Poisson3D_1LinearFormCoefficient0 f;
