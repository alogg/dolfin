...
public:
  ...
  Poisson2D_2BilinearForm(dolfin::FunctionSpace& V0, dolfin::FunctionSpace& V1) : dolfin::Form()
  {
    ...
    _ufc_form = new UFC_Poisson2D_2BilinearForm();

    check();
  }

  Poisson2D_2BilinearForm(std::tr1::shared_ptr<dolfin::FunctionSpace> V0, std::tr1::shared_ptr<dolfin::FunctionSpace> V1) : dolfin::Form()
  {
...
public:
  ...
  Poisson2D_2LinearForm(dolfin::FunctionSpace& V0, dolfin::Function& v0) : dolfin::Form()
  {
    std::tr1::shared_ptr<dolfin::FunctionSpace> _V0(&V0, dolfin::NoDeleter<dolfin::FunctionSpace>());
    _function_spaces.push_back(_V0);
    ...
    _ufc_form = new UFC_Poisson2D_2LinearForm();

    check();
  }

  Poisson2D_2LinearForm(std::tr1::shared_ptr<dolfin::FunctionSpace> V0, std::tr1::shared_ptr<dolfin::Function> v0) : dolfin::Form()
  {
    _function_spaces.push_back(V0);
