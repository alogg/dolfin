...
class poisson3d_1_0_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  poisson3d_1_0_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson3d_1_0_finite_element_0()
  {
    // Do nothing
  }
  ...
  {
    return new poisson3d_1_0_finite_element_0();
  }
...
class poisson3d_1_0_finite_element_1: public ufc::finite_element
{
public:

  /// Constructor
  poisson3d_1_0_finite_element_1() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson3d_1_0_finite_element_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::finite_element* create_sub_element(unsigned int i) const
  {
    return new poisson3d_1_0_finite_element_1();
  }
...
class poisson3d_1_0_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  poisson3d_1_0_dof_map_0() : ufc::dof_map()
  {
    __global_dimension = 0;
  }

  /// Destructor
  virtual ~poisson3d_1_0_dof_map_0()
  {
    // Do nothing
  }
  ...
  {
    return new poisson3d_1_0_dof_map_0();
  }
...
class poisson3d_1_0_dof_map_1: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  poisson3d_1_0_dof_map_1() : ufc::dof_map()
  {
    __global_dimension = 0;
  }

  /// Destructor
  virtual ~poisson3d_1_0_dof_map_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::dof_map* create_sub_dof_map(unsigned int i) const
  {
    return new poisson3d_1_0_dof_map_1();
  }
...
class poisson3d_1_0_cell_integral_0_quadrature: public ufc::cell_integral
{
public:

  /// Constructor
  poisson3d_1_0_cell_integral_0_quadrature() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson3d_1_0_cell_integral_0_quadrature()
  {
    // Do nothing
  }
                               ...
                               const ufc::cell& c) const
  {
    ...
    const static double FE0_D001[1][2] = \
    {{-1, 1}};
    ...
    const double G0 = W1*det*(Jinv_20*Jinv_20 + Jinv_21*Jinv_21 + Jinv_22*Jinv_22);
    const double G1 = W1*det*(Jinv_00*Jinv_20 + Jinv_01*Jinv_21 + Jinv_02*Jinv_22);
    const double G2 = W1*det*(Jinv_00*Jinv_10 + Jinv_01*Jinv_11 + Jinv_02*Jinv_12);
    const double G3 = W1*det*(Jinv_10*Jinv_10 + Jinv_11*Jinv_11 + Jinv_12*Jinv_12);
    const double G4 = W1*det*(Jinv_10*Jinv_20 + Jinv_11*Jinv_21 + Jinv_12*Jinv_22);
    const double G5 = W1*det*(Jinv_00*Jinv_00 + Jinv_01*Jinv_01 + Jinv_02*Jinv_02);
    ...
    // Total number of operations to compute element tensor: 150
    ...
    for (unsigned int j = 0; j < 2; j++)
    {
      for (unsigned int k = 0; k < 2; k++)
      {
        ...
        A[nzc0[j]*4 + nzc0[k]] += FE0_D001[0][j]*FE0_D001[0][k]*G0;
        // Number of operations to compute entry = 3
        A[nzc1[j]*4 + nzc0[k]] += FE0_D001[0][j]*FE0_D001[0][k]*G1;
        // Number of operations to compute entry = 3
        A[nzc1[j]*4 + nzc2[k]] += FE0_D001[0][j]*FE0_D001[0][k]*G2;
        // Number of operations to compute entry = 3
        A[nzc2[j]*4 + nzc2[k]] += FE0_D001[0][j]*FE0_D001[0][k]*G3;
        // Number of operations to compute entry = 3
        A[nzc2[j]*4 + nzc0[k]] += FE0_D001[0][j]*FE0_D001[0][k]*G4;
        // Number of operations to compute entry = 3
        A[nzc0[j]*4 + nzc2[k]] += FE0_D001[0][j]*FE0_D001[0][k]*G4;
        // Number of operations to compute entry = 3
        A[nzc2[j]*4 + nzc1[k]] += FE0_D001[0][j]*FE0_D001[0][k]*G2;
        // Number of operations to compute entry = 3
        A[nzc0[j]*4 + nzc1[k]] += FE0_D001[0][j]*FE0_D001[0][k]*G1;
        // Number of operations to compute entry = 3
        A[nzc1[j]*4 + nzc1[k]] += FE0_D001[0][j]*FE0_D001[0][k]*G5;
      }// end loop over 'k'
    }// end loop over 'j'
  }
...
class poisson3d_1_0_cell_integral_0: public ufc::cell_integral
{
private:

  poisson3d_1_0_cell_integral_0_quadrature integral_0_quadrature;

public:

  /// Constructor
  poisson3d_1_0_cell_integral_0() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson3d_1_0_cell_integral_0()
  {
    // Do nothing
  }
...
public:
  ...
  virtual const char* signature() const
  {
    return "Form([Integral(IndexSum(Product(SpatialDerivative(BasisFunction(FiniteElement('Lagrange', Cell('tetrahedron', 1), 1), 0), MultiIndex((Index(0),), {Index(0): 3})), SpatialDerivative(BasisFunction(FiniteElement('Lagrange', Cell('tetrahedron', 1), 1), 1), MultiIndex((Index(0),), {Index(0): 3}))), MultiIndex((Index(0),), {Index(0): 3})), Measure('cell', 0, None))])";
  }
  ...
  {
    return new poisson3d_1_0_cell_integral_0();
  }
...
class poisson3d_1_1_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  poisson3d_1_1_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson3d_1_1_finite_element_0()
  {
    // Do nothing
  }
  ...
  virtual ufc::finite_element* create_sub_element(unsigned int i) const
  {
    return new poisson3d_1_1_finite_element_0();
  }
...
class poisson3d_1_1_finite_element_1: public ufc::finite_element
{
public:

  /// Constructor
  poisson3d_1_1_finite_element_1() : ufc::finite_element()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson3d_1_1_finite_element_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::finite_element* create_sub_element(unsigned int i) const
  {
    return new poisson3d_1_1_finite_element_1();
  }
...
class poisson3d_1_1_dof_map_0: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  poisson3d_1_1_dof_map_0() : ufc::dof_map()
  {
    __global_dimension = 0;
  }

  /// Destructor
  virtual ~poisson3d_1_1_dof_map_0()
  {
    // Do nothing
  }
  ...
  virtual ufc::dof_map* create_sub_dof_map(unsigned int i) const
  {
    return new poisson3d_1_1_dof_map_0();
  }
...
class poisson3d_1_1_dof_map_1: public ufc::dof_map
{
private:
...
public:
  ...
  /// Constructor
  poisson3d_1_1_dof_map_1() : ufc::dof_map()
  {
    __global_dimension = 0;
  }

  /// Destructor
  virtual ~poisson3d_1_1_dof_map_1()
  {
    // Do nothing
  }
  ...
  virtual ufc::dof_map* create_sub_dof_map(unsigned int i) const
  {
    return new poisson3d_1_1_dof_map_1();
  }
...
class poisson3d_1_1_cell_integral_0_quadrature: public ufc::cell_integral
{
public:

  /// Constructor
  poisson3d_1_1_cell_integral_0_quadrature() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson3d_1_1_cell_integral_0_quadrature()
  {
    // Do nothing
  }
...
class poisson3d_1_1_cell_integral_0: public ufc::cell_integral
{
private:

  poisson3d_1_1_cell_integral_0_quadrature integral_0_quadrature;

public:

  /// Constructor
  poisson3d_1_1_cell_integral_0() : ufc::cell_integral()
  {
    // Do nothing
  }

  /// Destructor
  virtual ~poisson3d_1_1_cell_integral_0()
  {
    // Do nothing
  }
...
public:
  ...
  virtual ufc::cell_integral* create_cell_integral(unsigned int i) const
  {
    return new poisson3d_1_1_cell_integral_0();
  }
...
public:
  ...
  CoefficientSpace_f(const dolfin::Mesh & mesh):
      dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new poisson3d_1_1_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson3d_1_1_dof_map_1()), dolfin::reference_to_no_delete_pointer(mesh))))
  {
    // Do nothing
  }
  ...
  CoefficientSpace_f(boost::shared_ptr<dolfin::Mesh> mesh):
      dolfin::FunctionSpace(mesh,
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new poisson3d_1_1_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson3d_1_1_dof_map_1()), mesh)))
  {
      // Do nothing
  }
...
public:
  ...
  Form_0_FunctionSpace_0(const dolfin::Mesh & mesh):
      dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new poisson3d_1_0_finite_element_0()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson3d_1_0_dof_map_0()), dolfin::reference_to_no_delete_pointer(mesh))))
  {
    // Do nothing
  }
  ...
  Form_0_FunctionSpace_0(boost::shared_ptr<dolfin::Mesh> mesh):
      dolfin::FunctionSpace(mesh,
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new poisson3d_1_0_finite_element_0()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson3d_1_0_dof_map_0()), mesh)))
  {
      // Do nothing
  }
...
public:
  ...
  Form_0_FunctionSpace_1(const dolfin::Mesh & mesh):
      dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new poisson3d_1_0_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson3d_1_0_dof_map_1()), dolfin::reference_to_no_delete_pointer(mesh))))
  {
    // Do nothing
  }
  ...
  Form_0_FunctionSpace_1(boost::shared_ptr<dolfin::Mesh> mesh):
      dolfin::FunctionSpace(mesh,
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new poisson3d_1_0_finite_element_1()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson3d_1_0_dof_map_1()), mesh)))
  {
      // Do nothing
  }
...
public:
    ...
    dolfin::Form(2, 0)
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new poisson3d_1_form_0());
  }
...
public:
  ...
  Form_1_FunctionSpace_0(const dolfin::Mesh & mesh):
      dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new poisson3d_1_1_finite_element_0()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson3d_1_1_dof_map_0()), dolfin::reference_to_no_delete_pointer(mesh))))
  {
    // Do nothing
  }
  ...
  Form_1_FunctionSpace_0(boost::shared_ptr<dolfin::Mesh> mesh):
      dolfin::FunctionSpace(mesh,
                            boost::shared_ptr<const dolfin::FiniteElement>(new dolfin::FiniteElement(boost::shared_ptr<ufc::finite_element>(new poisson3d_1_1_finite_element_0()))),
                            boost::shared_ptr<const dolfin::DofMap>(new dolfin::DofMap(boost::shared_ptr<ufc::dof_map>(new poisson3d_1_1_dof_map_0()), mesh)))
  {
      // Do nothing
  }
...
public:
    ...
    dolfin::Form(1, 1), f(*this)
  {
    ...
    _ufc_form = boost::shared_ptr<const ufc::form>(new poisson3d_1_form_1());
  }
